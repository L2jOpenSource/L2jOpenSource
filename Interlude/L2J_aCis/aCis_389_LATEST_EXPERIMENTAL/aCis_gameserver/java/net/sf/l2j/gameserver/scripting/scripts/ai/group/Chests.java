			...
			if (!chest.isInteracted())
			{
				...
				if (Rnd.get(100) < 40)
				{
					switch (skill.getId())
					{
						...
						default:
							chest.getAI().tryTo(IntentionType.CAST, new SkillUseHolder(SkillTable.getInstance().getInfo(4143, Math.min(10, Math.round(npc.getLevel() / 10))), chest, false, false), null);
							break;
					}
				}
