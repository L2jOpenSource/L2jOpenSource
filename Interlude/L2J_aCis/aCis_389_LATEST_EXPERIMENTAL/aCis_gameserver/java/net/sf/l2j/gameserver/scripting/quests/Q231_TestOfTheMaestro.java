...
public class Q231_TestOfTheMaestro extends SecondClassQuest
{
	...
	public String onTimer(String name, Npc npc, Player player)
	{
		...
		if (name.equalsIgnoreCase("spawn_bugbears"))
		{
			...
			bugbear1.getAI().tryTo(IntentionType.ATTACK, player, null);
			...
			bugbear2.getAI().tryTo(IntentionType.ATTACK, player, null);
			...
			bugbear3.getAI().tryTo(IntentionType.ATTACK, player, null);
		}
