...
public class SummonStatus extends PlayableStatus
{
	...
	public void reduceHp(double value, L2Character attacker, boolean awake, boolean isDOT, boolean isHPConsumption)
	{
		...
		if ((attackerPlayer != null) && (getActiveChar().getOwner() != null) && getActiveChar().getOwner().isInDuel() && (getActiveChar().getOwner().getDuelId() != attackerPlayer.getDuelId()))
		{
			getActiveChar().getOwner().setDuelState(DuelState.INTERRUPTED);
