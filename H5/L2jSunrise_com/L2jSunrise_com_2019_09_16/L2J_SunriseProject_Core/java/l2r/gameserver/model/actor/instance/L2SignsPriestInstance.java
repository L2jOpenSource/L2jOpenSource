			...
			switch (val)
			{
				...
				case 6: // Contribute Seal Stones - SevenSigns 6 x
					...
					else
					{
						...
						String contentContr = HtmCache.getInstance().getHtm(player, player.getHtmlPrefix(), path);
				...
				case 17: // Exchange Seal Stones for Ancient Adena (Type Choice) - SevenSigns 17 x
					...
					String content = HtmCache.getInstance().getHtm(player, player.getHtmlPrefix(), path);
