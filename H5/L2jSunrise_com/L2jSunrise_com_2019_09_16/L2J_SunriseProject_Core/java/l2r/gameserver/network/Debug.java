...
public class Debug
{
	public static void sendSkillDebug(L2Character attacker, L2Character target, L2Skill skill, StatsSet set)
	{
		...
		msg.setFile(attacker.getActingPlayer(), attacker.getActingPlayer().getHtmlPrefix(), "data/html/admin/skilldebug.htm");
	...
	public static void sendItemDebug(L2PcInstance player, L2ItemInstance item, StatsSet set)
	{
		...
		final NpcHtmlMessage msg = new NpcHtmlMessage();
		msg.setFile(player, player.getHtmlPrefix(), "data/html/admin/itemdebug.htm");
