...
public final class RequestHennaEquip extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar.getHennaEx().getHennaEmptySlots() == 0)
		{
		...
		if (henna.isAllowedClass(activeChar.getClassId()) && (_count >= henna.getWearCount()) && (activeChar.getAdena() >= henna.getWearFee()) && activeChar.getHennaEx().addHenna(henna))
		{
