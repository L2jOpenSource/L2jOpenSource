...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public static void showCharacterList(Player activeChar, Player player)
	{
		...
		replyMSG.append("<tr><td width=100><font color=0099FF>Account:</font></td><td>" + player.getAccountName()+ "</td></tr>");
		replyMSG.append("<tr><td width=100><font color=0099FF>IP:</font></td><td>" + player.getIP() + "</td></tr>");
