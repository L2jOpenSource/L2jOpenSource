...
public class WeddingManagerInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("AcceptWedding"))
		{
			...
			Announcements.getInstance().announceByCustomMessage("l2f.gameserver.model.instances.L2WeddingManagerMessage.announce", new String[] { player.getName(), ptarget.getName() });
