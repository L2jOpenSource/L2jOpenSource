...
public enum Stats
{
	...
	CRITICAL_BASE("baseCrit", 0., Double.POSITIVE_INFINITY, 85.), // static crit rate. Use it to ADD some crit points. Sample: <add order="0x40" stat="baseCrit" val="27.4" />
	...
	REAL_ROOT_RESIST("realRootResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY),
	REAL_STUN_RESIST("realStunResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY),
	...
	PVP_SUMMON_PHYS_DMG_BONUS("pvpSummonPhysDmgBonus"),
	PVP_SUMMON_PHYS_SKILL_DMG_BONUS("pvpSummonPhysSkillDmgBonus"),
	PVP_SUMMON_MAGIC_SKILL_DMG_BONUS("pvpSummonMagicSkillDmgBonus"),
