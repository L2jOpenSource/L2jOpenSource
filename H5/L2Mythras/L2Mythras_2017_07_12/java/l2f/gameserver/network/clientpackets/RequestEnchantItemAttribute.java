...
public class RequestEnchantItemAttribute extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		boolean success = Rnd.chance(stone.getTemplate().isAttributeCrystal() ? Config.ENCHANT_ATTRIBUTE_CRYSTAL_CHANCE : Config.ENCHANT_ATTRIBUTE_STONE_CHANCE);
		...
		while (true)
		{
			...
			success = Rnd.chance(stone.getTemplate().isAttributeCrystal() ? Config.ENCHANT_ATTRIBUTE_CRYSTAL_CHANCE : Config.ENCHANT_ATTRIBUTE_STONE_CHANCE);
		}
