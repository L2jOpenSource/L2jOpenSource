...
public class ExBasicActionList extends L2GameServerPacket
{
	...
	{	
		...
		5001, // Increases Max . HP, Max . MP and Speed ​​by 20% , resistance to de-buff by 10%. Reuse time : 10 min . When using the skill spent 3 Essences Rose. Can not be used with the Beyond Temptation . Duration : 5 min .
		5002, // Increases Max . HP / MP / CP, P. . Def . and Mag . Def . 30% , Speed ​​by 20 %, P. Def . Atk . 10% , Mag . Atk . by 20% and decreases MP consumption by 15%. Reuse time : 40 min. When using the skill consumes 10 Essences Rose. Duration : 20 min.
