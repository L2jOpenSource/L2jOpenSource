<font color="919191">В списке</font> %count% <font color="919191">заблокированных HWID</font>
<table width=275>
    <tr>
        <td><edit var="srch" width=220 height=14></td>
        <td><button value="поиск" action="bypass -h admin_sg_bans 0 $srch" width=40 height=19 back="L2UI_ch3.smallbutton2" fore="L2UI_ch3.smallbutton2"></td>
    </tr>
</table>
<br>
<center>
