...
public class RateBonus extends Functions
{
	...
	{
		return "<a action=\"bypass -h scripts_services.RateBonus:get " + i + "\"> for " + i + " PK - " + Config.SERVICES_WASH_PK_PRICE * i + " " + ItemHolder.getInstance().getTemplate(Config.SERVICES_WASH_PK_ITEM).getName() + "</a><br>";
	}
