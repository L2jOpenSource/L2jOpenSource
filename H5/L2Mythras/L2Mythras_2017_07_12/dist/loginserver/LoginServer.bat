@echo off
COLOR 0b
title L2Mythras Login Server Console
:start
echo Login Server.
echo.
...
REM Debug ...
REM java -Dfile.encoding=UTF-8 -cp config;./../libs/* -Xmx1G -Xnoclassgc -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=7457 l2f.gameserver.GameServer
