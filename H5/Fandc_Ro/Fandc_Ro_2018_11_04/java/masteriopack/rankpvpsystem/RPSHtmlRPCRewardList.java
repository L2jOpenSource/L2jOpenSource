 ...
 */
package masteriopack.rankpvpsystem;
...
public class RPSHtmlRPCRewardList
{
	...
	private static String preparePage(Player player, int pageNo)
	{
		...
		return "<html><title>RPC Exchange</title><body><center><table border=0 cellspacing=0 cellpadding=0><tr><td><table><tr><td width=100 align=left> <font color=ae9977>RPC Total</font> </td><td align=center><font color=2080D0>"+RPSUtil.preparePrice(rpc.getRpcTotal())+"</font></td></tr><tr><td width=100 align=left> <font color=ae9977>RPC Current</font> </td><td width=170 align=center><font color=2080D0>"+RPSUtil.preparePrice(rpc.getRpcCurrent())+"</font></td></tr></table></td></tr><tr><td height=8>&nbsp;</td></tr><tr><td FIXWIDTH=270 HEIGHT=4><img src=\"L2UI.Squaregray\" width=\"270\" height=\"1\"></img></td></tr><tr><td height=8></td></tr><tr><td>"+getRpcRewardList(pageNo)+"</td></tr><tr><td>&nbsp;</td></tr><tr><td HEIGHT=4></td></tr><tr><td>"+getPageChanger(pageNo)+"</td></tr><tr><td FIXWIDTH=270 HEIGHT=4><img src=\"L2UI.Squaregray\" width=\"270\" height=\"1\"></img></td></tr><tr><td align=center><button value=\"Back\" action=\"bypass RPS.PS\"  width="+RPSConfig.BUTTON_W+" height="+RPSConfig.BUTTON_H+" back=\""+RPSConfig.BUTTON_DOWN+"\" fore=\""+RPSConfig.BUTTON_UP+"\"></td></tr></table></center></body></html>";
	}
