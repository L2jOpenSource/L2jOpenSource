...
import masteriopack.rankpvpsystem.RewardTable.Reward;
...
public class RPCHtmlRewardList
{
	...
	private static String preparePage(Player player, int pageNo, int rankId)
	{
		...
		return "<html><title>Rank Reward List</title><body><center><table border=0 cellspacing=0 cellpadding=0><tr><td><table><tr><td width=100 align=left> <font color=ae9977></font> </td><td align=center><font color=2080D0></font></td></tr><tr><td width=100 align=left> <font color=ae9977></font> </td><td width=170 align=center><font color=2080D0></font></td></tr></table></td></tr><tr><td height=8>&nbsp;</td></tr><tr><td FIXWIDTH=270 HEIGHT=4><img src=\"L2UI.Squaregray\" width=\"270\" height=\"1\"></img></td></tr><tr><td height=8></td></tr><tr><td>"+text[0]+"</td></tr><tr><td>&nbsp;</td></tr><tr><td HEIGHT=4></td></tr><tr><td>"+text[1]+"</td></tr><tr><td FIXWIDTH=270 HEIGHT=4><img src=\"L2UI.Squaregray\" width=\"270\" height=\"1\"></img></td></tr><tr><td align=center><button value=\"Back\" action=\"bypass RPS.PS\" width="+RPSConfig.BUTTON_W+" height="+RPSConfig.BUTTON_H+" back=\""+RPSConfig.BUTTON_DOWN+"\" fore=\""+RPSConfig.BUTTON_UP+"\"></td></tr></table></center></body></html>";
	}
