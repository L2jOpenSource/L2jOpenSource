...
public class RuVotesHolder
{
	...
	private void loadVotes()
	{
		try (Connection con = DatabaseFactory.getInstance().getConnection();
		     PreparedStatement statement = con.prepareStatement("SELECT * FROM ru_votes");
	...
	public void saveNewVotes(List<RuVote> correctVotes)
	{
		...
		try (Connection con = DatabaseFactory.getInstance().getConnection();
		     PreparedStatement statement = BatchStatement.createPreparedStatement(con, "INSERT INTO ru_votes VALUES (?,?)"))
		{
	...
	public void wipeVotes()
	{
		...
		try (Connection con = DatabaseFactory.getInstance().getConnection();
		     PreparedStatement statement = con.prepareStatement("DELETE FROM ru_votes"))
		{
			statement.execute();
		}
		catch (SQLException e)
