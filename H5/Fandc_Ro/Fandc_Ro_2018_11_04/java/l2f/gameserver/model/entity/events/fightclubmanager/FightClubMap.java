...
public class FightClubMap
{
	...
	public FightClubMap(MultiValueSet<String> params, Map<FightClubTeamType, LinkedList<Location[]>> teamSpawns,
			Map<String, ZoneTemplate> territories, Location[] keyLocations, NpcGroupLocation[] npcLocations)
	{
		// Params
		this._params = params;
