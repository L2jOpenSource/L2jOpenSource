...
public final class AwayManager
{
	...
	public void setAway(Player activeChar, String text)
	{
		...
		activeChar.broadcastPacket(new L2GameServerPacket[] { new SocialAction(activeChar.getObjectId(), 9) });
		activeChar.sendMessage(new CustomMessage("l2f.gameserver.instancemanager.AwayManager.setAway", activeChar, new Object[] { Integer.valueOf(Config.AWAY_TIMER) }));
	...
	{
		activeChar.sendMessage(new CustomMessage("l2f.gameserver.instancemanager.AwayManager.setBack", activeChar, new Object[] { Integer.valueOf(Config.BACK_TIMER) }));
	...
	private class setPlayerAwayTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_activeChar.sendMessage(new CustomMessage("l2f.gameserver.instancemanager.AwayManager.setPlayerAwayTask", _activeChar, new Object[] { _awayText }));
			}
