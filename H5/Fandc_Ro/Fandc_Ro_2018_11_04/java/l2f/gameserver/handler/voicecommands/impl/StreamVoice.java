...
public class StreamVoice extends Functions implements IVoicedCommandHandler
{
	...
	private void showMainStreamerPage(Player player)
	{
		...
		if (!myStream.isTitleCorrect())
			...
			rewards.append("<font color=d50000>You have been punished! Contact Game Administrators for more info.<br1>"
				+ "End Date: " + END_DATE_FORMAT.format(myStream.getPunishedUntilDate()) + "</font>");
