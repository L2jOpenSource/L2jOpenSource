...
public class AdminStream implements IAdminCommandHandler
{
	...
	private static void punishStream(Stream stream, long hours)
	{
		...
		if (activeStreamer != null)
			activeStreamer.sendPacket(new Say2(0, ChatType.COMMANDCHANNEL_ALL, StringHolder.getNotNull(activeStreamer, "Twitch.Stream", new Object[0]), StringHolder.getNotNull(activeStreamer, "Twitch.PunishedForHours", new Object[] { hours })));
	}
