...
public final class FakePlayerNpcsParser extends AbstractFileParser<FakePlayerNpcsHolder>
{
	...
	{
		final Document document = this._reader.read(CryptUtil.decryptOnDemand(this.getXMLFile()));
		writeTemplateToDocument(document, template);
		final OutputFormat format = OutputFormat.createPrettyPrint();
		final XMLWriter writer = new XMLWriter(new FileOutputStream(this.getXMLFile()), format);
