...
public class Formulas
{
	...
	public static boolean calcSkillSuccess(Env env, EffectTemplate et, int spiritshot)
	{
		...
		env.value = Math.max(env.value, Math.min(base, Config.SKILLS_CHANCE_MIN)); // If the base chance is more than Config.SKILLS_CHANCE_MIN, then with a small difference in the levels, make a cap from below.
