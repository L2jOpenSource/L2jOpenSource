...
public class CharacterSelectionInfo extends L2GameServerPacket
{
	...
	public static CharSelectInfoPackage[] loadCharacterSelectInfo(String loginName)
	{
		...
		try (Connection con = DatabaseFactory.getInstance().getConnection();
				PreparedStatement statement = con.prepareStatement("SELECT obj_Id, sex, char_name, x, y, z, pkkills, pvpkills, face, hairstyle, haircolor, clanid, karma, deletetime, lastAccess, accesslevel, vitality FROM characters WHERE account_name=? LIMIT 7"))
		{
