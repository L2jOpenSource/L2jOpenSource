...
public enum SystemMsg implements IStaticPacket
{
	...
	THE_SIEGE_OF_S1_HAS_STARTED(711), // $s1: осада началась.
	...
	C1_HAS_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_HAS_BEEN_INVESTIGATED(2481), // Персонаж $c1 сообщил о том, что Вы используете нелегальную программу, поэтому Вы не сможете получить награду.
	C1_HAS_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_CANNOT_JOIN_A_PARTY(2482), // Персонаж $c1 сообщил о том, что Вы используете нелегальную программу, поэтому Вы не можете вступить в группу.
	...
	YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_PARTICIPATING_IN_A_PARTY_IS_NOT_ALLOWED(2484), // Получено сообщение о том, что Вы используете нелегальную программу, поэтому Вы не сможете вступить в группу.
	YOU_HAVE_BEEN_REPORTED_AS_AN_ILLEGAL_PROGRAM_USER_AND_YOUR_ACTIVITIES_ARE_ONLY_ALLOWED_WITHIN(2485), // Получено сообщение о том, что Вы используете нелегальную программу, поэтому Вы будете ограничены в движениях.
	YOU_HAVE_BEEN_BLOCKED_DUE_TO_VERIFICATION_THAT_YOU_ARE_USING_A_THIRD_PARTY_PROGRAM_SUBSEQUENT(2486), // До сих пор Вы получали штрафы за использование нелегальных программ в соответствии с количеством имеющихся у Вас очков. Со следующего раза штраф будет предусматривать не только игровые штрафы,
