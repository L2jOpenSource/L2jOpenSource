...
public class Say2C extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (emotion != -1 && !World.getAroundPlayers(activeChar, 300, 300).isEmpty() && !activeChar.isInCombat() && !activeChar.isDead() && !activeChar.isCastingNow()
			&& !activeChar.isSitting() && !activeChar.isNotShowEmotions())
		{
