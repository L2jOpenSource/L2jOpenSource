		...
		try
		{
			if (academyChar.getPledgePrice() != 0)
			{
				...
				academyChar.sendChatMessage(academyChar.getObjectId(), ChatType.BATTLEFIELD.ordinal(), "Academy",
				                            "You have accepted to join " + activeChar.getName() + "'s clan. On academy finish you will recive " + Util.formatAdena(academyChar.getPledgePrice()) + " " + ItemHolder.getInstance().getTemplateName(itemId) + ".");
