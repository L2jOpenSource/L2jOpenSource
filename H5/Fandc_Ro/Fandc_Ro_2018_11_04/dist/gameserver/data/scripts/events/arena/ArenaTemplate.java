...
public abstract class ArenaTemplate extends Functions
{
	...
	public void template_announce()
	{
		...
		{
			_timeToStart--;
			say(creator.getName() + " created a battle " + _team1count + "х" + _team2count + ", " + _team1min + "-" + _team1max + "lv vs " + _team2min + "-" + _team2max + "lv, rate " + (_battleType == 1 ? _price + "а" : "experience") + ", Start over " + _timeToStart + " min");
			executeTask("events.arena." + _className, "announce", new Object[0], 60000);
		}
