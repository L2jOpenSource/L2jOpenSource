...
public class CommunityPartyMatching extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	private ClassId[] getNeededClasses(int type)
	{
		switch (type)
		{
			...
			case 1: //Buffers
				ClassId[] classes = {ClassId.inspector, ClassId.judicator, ClassId.oracle, ClassId.orcShaman, ClassId.prophet, ClassId.warcryer, ClassId.overlord, ClassId.shillienElder, ClassId.shillienSaint, ClassId.hierophant, ClassId.evaSaint, ClassId.shillienSaint, ClassId.dominator, ClassId.doomcryer};
				return  classes;
			case 2: //BD
