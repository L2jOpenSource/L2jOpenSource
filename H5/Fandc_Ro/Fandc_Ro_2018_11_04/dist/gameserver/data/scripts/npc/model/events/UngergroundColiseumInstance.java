...
public class UngergroundColiseumInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (actualCommand.startsWith("winner"))
		{
			...
			NpcHtmlMessage html;
			/*
			 * if(UnderGroundColliseumManager.getInstance().getColiseumByLevelLimit(getMaxLevel()).getPreviusWinners() != null) { filename = "data/html/Coliseum/"+ 7 + "htm"; html = new NpcHtmlMessage(player, this, filename, 7); html.replace("winner",
