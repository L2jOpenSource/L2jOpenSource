...
public final class HellboundLoader
{
	...
	{
		_log.info(getClass().getSimpleName() + ": Loading Hellbound related scripts");
		// Data
	...
	private static final Class<?>[] SCRIPTS =
	{
		...
		RankuFloor.class,
	// Quests
	// Already handled by QuestLoader
	// Q00130_PathToHellbound.class,
	// Q00133_ThatsBloodyHot.class,
	};
	
	public static HellboundLoader getInstance()
	{
	...
	{
		protected static final HellboundLoader INSTANCE = new HellboundLoader();
	}
}
