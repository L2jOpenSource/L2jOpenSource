...
public final class SystemMessageId
{
	...
	/**
	 * ID: 3266<br>
	 * Message: The angel Nevit has blessed you from above. You are imbued with full Vitality as well as a Vitality Replenishing effect. And should you die, you will not lose Exp! Nevit's Advent Blessing is Upon You!
	 */
	 ...
	 */
	public static final SystemMessageId YOU_EXCEEDED_MAX_OF_PC_CAFE_POINTS = new SystemMessageId(6506);
