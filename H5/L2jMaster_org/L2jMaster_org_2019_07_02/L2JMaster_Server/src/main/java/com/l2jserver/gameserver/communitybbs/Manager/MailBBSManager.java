...
public class MailBBSManager extends BaseBBSManager
{
	...
	private void showInbox(L2PcInstance activeChar, int page)
	{
		...
		html.append("<td fixWIDTH=12><a action=\"bypass _maillist_0_1_0_\">[Inbox]</a>" + "(" + countLetters(activeChar, "inbox") + ")</td>");
		html.append("<td fixWIDTH=14><a action=\"bypass _maillist_0_1_0_sentbox\">[Sent Box]</a>" + "(" + countLetters(activeChar, "sentbox") + ")</td>");
		html.append("<td fixWIDTH=16><a action=\"bypass _maillist_0_1_0_archive\">[Mail Archive]</a>" + "(" + countLetters(activeChar, "archive") + ")</td>");
		html.append("<td fixWIDTH=71><a action=\"bypass _maillist_0_1_0_temp_archive\">[Temp. Mail Archive]</a>" + "(" + countLetters(activeChar, "temparchive") + ")</td>");
		html.append("<td fixWIDTH=2></td>");
		html.append("</tr>");
		html.append("<tr><td></td></tr>");
		html.append("</table>");
		html.append("<br>");
		html.append("<table border=0 cellspacing=0 cellpadding=2 bgcolor=A7A19A width=755>");
		html.append("<tr>");
		...
		//html.append("</tr></table>");
		html.append("<center><table border=0 cellpadding=0 width=55 height=10><tr>");
		html.append("<td width=16 height=16 align=center valign=top>");
		html.append("<button action=\"bypass _maillist_0_1_0_ ").append(page == 1 ? page : page - 1).append("\" width=16 height=16 back=\"L2UI_ct1.button_df_left_down\" fore=\"L2UI_ct1.button_df_left\"></td>");
		html.append("<td width=30 height=16 align=center valign=top>1</td>");
		/*for (int i = 1; i <= 7; i++)
		{
			html.append("<td align=center fixedwidth=10><a action=\"bypass _maillist_0_1_0_ ").append(i).append("\">").append(i).append("</a></td>");
		}*/
		html.append("<td width=16 height=16 align=center valign=top>");
		html.append("<button action=\"bypass _maillist_0_1_0_ ").append(page + 1).append("\" width=16 height=16 back=\"L2UI_ct1.button_df_right_down\" fore=\"L2UI_ct1.button_df_right\"></td>");
		...
		html.append("<tr>");
		html.append("<td><combobox width=75 var=item list=Writer;Title;></td>");
		html.append("<td><edit var =\"Search\" width=130 height=15></td>");
		html.append("<td><button value=\"&$420;\" action=\"Write 5 -2 0 Search _ _\" back=\"L2UI_ct1.button_df\" width=65 height=25 fore=\"L2UI_ct1.button_df\"></td>");
		html.append("</tr>");
		html.append("</table>");
		html.append("<center></center><br>");
	...
	private void showSentbox(L2PcInstance activeChar, int page)
	{
		...
		html.append("<center><br><br>");
		html.append("<table border=0 width=755><tr><td width=10></td><td width=600 align=left>");
		html.append("<a action=\"bypass _bbshome\">HOME</a>&nbsp;>&nbsp;<a action=\"bypass _maillist_0_1_0_\">Sent Box</a>");
		html.append("</td></tr>");
		html.append("</table>");
		html.append("<center>");
		html.append("<table border=0 cellspacing=0 cellpadding=0>");
		...
		html.append("<tr>");
		html.append("<td FIXWIDTH=5></td>");
		html.append("<td FIXWIDTH=100 align=center>To</td>");
		html.append("<td FIXWIDTH=400 align=left>Title</td>");
		html.append("<td FIXWIDTH=150 align=center>Authoring Date</td>");
		html.append("<td FIXWIDTH=5></td>");
		html.append("</tr></table>");
		...
		{
			html.append("<br><center></center><br>");
		}
		else
		{
			html.append("<br>");
	...
	private void showMailArchive(L2PcInstance activeChar, int page)
	{
		...
		html.append("<center><br><br>");
		html.append("<table border=0 width=755><tr><td width=10></td><td width=600 align=left>");
		html.append("<a action=\"bypass _bbshome\">HOME</a>&nbsp;>&nbsp;<a action=\"bypass _maillist_0_1_0_\">Mail Archive</a>");
		html.append("</td></tr>");
		html.append("</table>");
		html.append("<center>");
		html.append("<table border=0 cellspacing=0 cellpadding=0>");
	...
	private void showTempMailArchive(L2PcInstance activeChar, int page)
	{
		...
		html.append("<center><br><br>");
		html.append("<table border=0 width=755><tr><td width=10></td><td width=600 align=left>");
		html.append("<a action=\"bypass _bbshome\">HOME</a>&nbsp;>&nbsp;<a action=\"bypass _maillist_0_1_0_\">Temp. Mail Archive</a>");
		html.append("</td></tr>");
		html.append("</table>");
		html.append("<center>");
		html.append("<table border=0 cellspacing=0 cellpadding=0>");
	...
	void sendLetter(String recipients, String subject, String message, L2PcInstance activeChar)
	{
		try (Connection con = ConnectionFactory.getInstance().getConnection())
		{
