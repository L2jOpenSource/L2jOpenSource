...
public class ConfigData
{
	...
	private static final String EVENT_CONFIG = "./config/EventEngine/EventEngine.ini";
	private static final String TVT_CONFIG = "./config/EventEngine/TeamVsTeam.ini";
	private static final String AVA_CONFIG = "./config/EventEngine/AllVsAll.ini";
	private static final String CTF_CONFIG = "./config/EventEngine/CaptureTheFlag.ini";
	private static final String OVO_CONFIG = "./config/EventEngine/OneVsOne.ini";
	private static final String SURVIVE_CONFIG = "./config/EventEngine/Survive.ini";
