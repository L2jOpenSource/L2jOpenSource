...
INSERT IGNORE INTO `raidboss_spawnlist` (`boss_id`,`loc_x`,`loc_y`,`loc_z`,`heading`,`respawn_min_delay`,`respawn_max_delay`,`currentHp`,`currentMp`) VALUES
...
-- (25609,0,0,0,0,43200,129600,9999,9999), -- Epidos (82) (stats to be done)
-- (25610,0,0,0,0,43200,129600,9999,9999), -- Epidos (82) (stats to be done)
-- (25611,0,0,0,0,43200,129600,9999,9999), -- Epidos (82) (stats to be done)
-- (25612,0,0,0,0,43200,129600,9999,9999), -- Epidos (82) (stats to be done)
...
(25623,-192361,254528,1598,0,0,3600,737579,3718), -- Valdstone (80)
(25624,-174600,219711,4424,0,0,3600,759929,3945), -- Rok (80)
(25625,-181989,208968,4424,0,0,3600,775204,4099), -- Enira (80)
(25626,-252898,235845,5343,0,0,0,51431,2253), -- Dius (80)
-- (25643,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Sentry (81) (stats to be done)
-- (25644,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Severer (81) (stats to be done)
-- (25645,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Soul Extractor (81) (stats to be done)
-- (25646,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Soul Devourer (81) (stats to be done)
-- (25647,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Fighter (81) (stats to be done)
-- (25648,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Fighter (81) (stats to be done)
-- (25649,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Executor (81) (stats to be done)
-- (25650,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Executor (81) (stats to be done)
-- (25651,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Prophet  (81) (stats to be done)
-- (25652,0,0,0,0,43200,129600,9999,9999), -- Awakened Ancient Prophet (81) (stats to be done)
...
-- (25665,0,0,0,0,43200,129600,9999,9999), -- Yehan Klodekus (81) (stats to be done)
-- (25666,0,0,0,0,43200,129600,9999,9999), -- Yehan Klanikus (81) (stats to be done)
-- (25667,0,0,0,0,43200,129600,9999,9999), -- Cannibalistic Stakato Chief (82) (stats to be done)
...
(25696,-180146,175202,-10287,13632,64800,86400,1206907,20499), -- Taklacan (85)
(25697,-174800,186738,-15100,49504,64800,86400,9974437,20499), -- Torumba (85)
(25698,-213004,175631,-11978,16380,64800,86400,997444,20499), -- Dopagen (85)
...
(29030,189635,-116550,-1583,0,0,0,104586,1657), -- Fenril Hound Kerinne (84) (stats to be done)
(29033,193173,-113259,-1347,0,0,0,105872,1708), -- Fenril Hound Freki (84) (stats to be done)
(29036,190083,-109972,-1024,0,0,0,214199,1759), -- Fenril Hound Uruz (84) (stats to be done)
(29037,189559,-110170,-1020,0,0,0,108266,1812), -- Fenril Hound Kinaz (84) (stats to be done)
...
(29062,-16373,-53562,-10197,0,43200,129600,275385,9999), -- Andreas Van Halter (80) -- stats to be done
