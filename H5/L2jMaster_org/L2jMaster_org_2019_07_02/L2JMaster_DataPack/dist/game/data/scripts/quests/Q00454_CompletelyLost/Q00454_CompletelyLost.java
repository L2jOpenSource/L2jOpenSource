		...
		switch (event)
		{
			...
			case "CHECK_TIMER":
			{
				...
				if (leader != null)
				{
					...
					if (dist > 1000)
					{
						if (npc.isInsideRadius(new Location(-179630, 183394, -15172), 300, false, false) || npc.isInsideRadius(new Location(-212545, 184081, -11011), 300, false, false))
						{
							npc.teleToLocation(leader.getLocation());
							npc.getAI().setIntention(CtrlIntention.AI_INTENTION_FOLLOW, leader);
							startQuestTimer("TIME_LIMIT1", 60000, npc, null);
							break;
						}
