	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "SPAWN_KING_BUGBEAR":
			{
				...
				addAttackDesire(addSpawn(KING_BUGBEAR, 140347, -194167, -3146, 0, false, 200000, false), player);
				addAttackDesire(addSpawn(KING_BUGBEAR, 140322, -194130, -3146, 0, false, 200000, false), player);
				break;
			}
		}
		return htmltext;
		...
		if ((qs != null) && qs.isStarted() && Util.checkIfInRange(1500, npc, killer, true))
		{
			switch (npc.getId())
			{
				case GIANT_MIST_LEECH:
				{
					...
					{
						giveItems(killer, BLOOD_OF_LEECH, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case STINGER_WASP:
				{
					...
					{
						giveItems(killer, STINGER_WASP_NEEDLE, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case MARSH_SPIDER:
				{
					...
					{
						giveItems(killer, MARSH_SPIDERS_WEB, 1 * (int) Config.RATE_QUEST_DROP);
