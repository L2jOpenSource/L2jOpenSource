...
public final class TowerOfNaia extends AbstractNpcAI
{
	...
	private static final int BELETH_ASSASSIN_1 = 22439;
	private static final int BELETH_ASSASSIN_2 = 22440;
	...
	public TowerOfNaia()
	{
		...
		addSpawnId(MUTATED_ELPY, SPORE_BASIC, LOCK, BELETH_ASSASSIN_1, BELETH_ASSASSIN_2);
	...
	public final String onSpawn(L2Npc npc)
	{
		...
		else if ((npcId == BELETH_ASSASSIN_1) || (npcId == BELETH_ASSASSIN_2))
		{
		...
		if ((party != null) && ZONES.containsKey(managerId) && (ZoneManager.getInstance().getZoneById(ZONES.get(managerId)) != null))
		{
			...
			for (L2PcInstance player : zone.getPlayersInside())
			{
				if (player != null)
				{
					...
					{
						player.teleToLocation(16046, 243752, 11616);
					}
				}
			}
		}
