...
import NewbieGuide.NewbieGuideWD;
import NewbieGuide.handler.NewbieGuideBypassHandler;
import PremiumSystem.PremiumItemSystem;
import Runes.RuneSpoilAdena;
import SellbuffOffline.SellbuffOfflineSQL;
import SupportReward.SupportReward;
import SwitchSubclass.SwitchSubclass;
import SwitchSubclass.handler.SwitchSubclassBypasshandler;
import SwitchSubclass.handler.SwitchSubclassIHandler;
import augmentManager.AugmentManager;
import custom.ToTown.ToTown;
import custom.events.LegionSquad.LegionSquad;
import custom.events.TreasureLegion.TreasureLegion;
import extras.VisualEquip;
...
import handlers.admincommandhandlers.AdminPrimeShop;
...
import handlers.bypasshandlers.AntiBot;
...
import handlers.punishmenthandlers.DualBoxProtection;
...
import handlers.voicedcommandhandlers.PlayerStats;
...
public class MasterHandler
{
	...
	private static final Class<?>[][] HANDLERS =
	{
		...
		},
		{
			...
			VoiceCommand.class,
			Wear.class,
			NewbieGuideBypassHandler.class,
			SwitchSubclassBypasshandler.class,
		},
		{
			// Chat Handlers
			ChatAll.class,
		...
		},
		{
			...
			(Config.ENABLE_ONLINE_STATUS ? OnlineStatus.class : null),
			(Config.ALLOW_REPAIR_COMMAND ? RepairVCmd.class : null),
		...
		},
		{
			...
			VisualEquip.class,
			LegionSquad.class,
			TreasureLegion.class,
			AugmentManager.class,
			NewbieGuideWD.class,
			RuneSpoilAdena.class,
			SellbuffOfflineSQL.class,
			SupportReward.class,
			SwitchSubclass.class,
			SwitchSubclassIHandler.class,
			PremiumItemSystem.class,
			PlayerStats.class
		}
	};
