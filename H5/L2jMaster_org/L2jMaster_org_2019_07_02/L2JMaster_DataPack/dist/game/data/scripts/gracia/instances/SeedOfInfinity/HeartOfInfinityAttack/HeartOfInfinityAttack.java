 ...
 */
package gracia.instances.SeedOfInfinity.HeartOfInfinityAttack;
...
import com.l2jserver.gameserver.model.stats.functions.FuncSet;
...
/**
 * Seed of Infinity (Heart Of Infinity Attack) instance zone.
 * @author MaGa1, Sacrifice
 */
public final class HeartOfInfinityAttack extends AbstractNpcAI
{
	private class HIAWorld extends InstanceWorld
	{
		protected List<L2Npc> npcList = new ArrayList<>();
		protected List<L2Npc> startroom = new ArrayList<>();
		protected List<L2Npc> deadTumors = new ArrayList<>();
		protected L2Npc ekimus;
		protected L2Npc deadTumor;
		protected List<L2Npc> feralHounds = new ArrayList<>(2);
	...
	private static final int INSTANCE_ID = 121;
	private static final int ZONE_ID = 200032;
	private static final int DOOR_ID = 14240102;
	
	private static final int GATEKEEPER_OF_ABYSS = 32539;
	private static final int TUMOR_OF_DEATH = 18708;
	// @formatter:off
	private static final int[] DESTROYED_TUMOR = {32535, 32536};
	// @formatter:on
	private static final int LORD_OF_IMMORTALITY_EKIMUS = 29150;
	private static final int FERAL_HOUND_OF_THE_NETHERWORLD = 29151;
	// @formatter:off
	protected static final int[] SOUL_COFFIN = {18710, 18711};
	// @formatter:on
	...
	// @formatter:off
	private static final int[] ENTER_TELEPORT = {-179284, 205990, -15520};
	private static final int[] NOT_MOVE = {SOUL_COFFIN[0], SOUL_COFFIN[1], TUMOR_OF_DEATH, DESTROYED_TUMOR[0]};
	
	private static final int[][] MOBS_OF_ROOMS_SPAWN =
	{
		{22520, -179949, 206751, -15521, 0, 60, 1}, {22522, -179949, 206505, -15522, 0, 60, 1},
		{22532, -180207, 206362, -15512, 0, 60, 1}, {22520, -180046, 206109, -15511, 0, 60, 1},
		{22526, -179843, 205686, -15511, 0, 60, 1}, {22522, -179658, 206002, -15518, 0, 60, 1},
		{22526, -179465, 205648, -15498, 0, 60, 1}, {22520, -179262, 205896, -15536, 0, 60, 1},
		{22526, -178907, 205950, -15509, 0, 60, 1}, {22532, -179128, 206423, -15528, 0, 60, 1},
		{22522, -179262, 206890, -15524, 0, 60, 1}, {22516, -177238, 208020, -15521, 0, 60, 1},
		{22522, -177202, 207533, -15516, 0, 60, 1}, {22532, -176900, 207515, -15511, 0, 60, 1},
		{22524, -176847, 208022, -15523, 0, 60, 1}, {22516, -176187, 207648, -15499, 0, 60, 1},
		{22522, -176044, 208039, -15524, 0, 60, 1}, {22532, -176346, 208233, -15533, 0, 60, 1},
		{22524, -176440, 208594, -15527, 0, 60, 1}, {22516, -176938, 208543, -15529, 0, 60, 1},
		{22524, -176763, 208108, -15523, 0, 60, 1}, {22522, -176483, 207762, -15520, 0, 60, 1},
		{22526, -177125, 210766, -15517, 0, 60, 1}, {22520, -176810, 210587, -15515, 0, 60, 1},
		{22522, -176820, 210975, -15528, 0, 60, 1}, {22524, -176412, 210873, -15510, 0, 60, 1},
		{22526, -176261, 211197, -15511, 0, 60, 1}, {22520, -176241, 211649, -15503, 0, 60, 1},
		{22522, -176656, 211884, -15516, 0, 60, 1}, {22524, -176798, 211540, -15541, 0, 60, 1},
		{22526, -177130, 211694, -15533, 0, 60, 1}, {22520, -177436, 211384, -15519, 0, 60, 1},
		{22522, -177138, 211159, -15524, 0, 60, 1}, {22526, -179311, 212338, -15521, 0, 60, 1},
		{22522, -178985, 212502, -15513, 0, 60, 1}, {22516, -179313, 212730, -15522, 0, 60, 1},
		{22520, -178966, 213036, -15510, 0, 60, 1}, {22526, -179352, 213172, -15511, 0, 60, 1},
		{22522, -179696, 213427, -15514, 0, 60, 1}, {22516, -180096, 213140, -15519, 0, 60, 1},
		{22520, -179957, 212724, -15530, 0, 60, 1}, {22522, -180240, 212578, -15518, 0, 60, 1},
		{22520, -179891, 212271, -15520, 0, 60, 1}, {22516, -179593, 212488, -15523, 0, 60, 1},
		{22516, -181746, 211163, -15515, 0, 60, 1}, {22522, -182002, 211394, -15522, 0, 60, 1},
		{22526, -181796, 211647, -15511, 0, 60, 1}, {22516, -182160, 211615, -15518, 0, 60, 1},
		{22520, -182322, 211843, -15510, 0, 60, 1}, {22522, -182720, 211686, -15519, 0, 60, 1},
		{22520, -182721, 211231, -15535, 0, 60, 1}, {22516, -182957, 210874, -15515, 0, 60, 1},
		{22526, -182705, 210606, -15526, 0, 60, 1}, {22520, -182359, 210871, -15526, 0, 60, 1},
		{22522, -182051, 210644, -15521, 0, 60, 1}, {22524, -181994, 208452, -15514, 0, 60, 1},
		{22516, -182342, 208661, -15510, 0, 60, 1}, {22526, -182471, 208349, -15519, 0, 60, 1},
		{22520, -182960, 208335, -15504, 0, 60, 1}, {22524, -182751, 207925, -15514, 0, 60, 1},
		{22516, -182671, 207442, -15531, 0, 60, 1}, {22520, -182276, 207438, -15527, 0, 60, 1},
		{22526, -181975, 207353, -15520, 0, 60, 1}, {22524, -181989, 207795, -15527, 0, 60, 1},
		{22516, -181744, 207997, -15520, 0, 60, 1}, {22520, -182318, 208070, -15523, 0, 60, 1},
		{18667, -178430, 211520, -15504, 28672, 120, 1}, {18668, -177341, 209129, -15504, 16384, 120, 1},
		{18711, -178067, 207862, -15504, 8192, 120, 1}, {18667, -180679, 207614, -15520, 61439, 120, 1},
		{18668, -181761, 209949, -15520, 49151, 120, 1}, {18711, -180328, 211686, -15504, 36863, 120, 1}
	};
	
	private static final int[][] TUMORS_OF_DEATH_SPAWN =
	{
		{18708, -179779, 212540, -15520, 49151, 0, 1}, {18708, -177028, 211135, -15520, 36863, 0, 1},
		{18708, -176355, 208043, -15520, 28672, 0, 1}, {18708, -179284, 205990, -15520, 16384, 0, 1},
		{18708, -182268, 208218, -15520, 4096, 0, 1}, {18708, -182069, 211140, -15520, 61439, 0, 1}
	};
	
	protected static final int[][] BOSSES_SPAWN =
	{
		{25637, -179303, 213090, -15504, 49151, 0, 1}, {25638, -176426, 211219, -15504, 36863, 0, 1},
		{25639, -177040, 207870, -15504, 28672, 0, 1}, {25640, -179762, 206479, -15504, 16384, 0, 1},
		{25641, -182388, 207599, -15504, 4096, 0, 1}, {25642, -182733, 211096, -15504, 61439, 0, 1}
	};
	// @formatter:on
	
	public HeartOfInfinityAttack()
	{
		super(HeartOfInfinityAttack.class.getSimpleName(), "gracia/instances");
		
		addStartNpc(GATEKEEPER_OF_ABYSS, DESTROYED_TUMOR[0], DESTROYED_TUMOR[1]);
		addTalkId(GATEKEEPER_OF_ABYSS, DESTROYED_TUMOR[0], DESTROYED_TUMOR[1]);
		...
		addSpawnId(LORD_OF_IMMORTALITY_EKIMUS, FERAL_HOUND_OF_THE_NETHERWORLD);
		addAttackId(LORD_OF_IMMORTALITY_EKIMUS);
		addKillId(TUMOR_OF_DEATH, SOUL_COFFIN[0], SOUL_COFFIN[1], LORD_OF_IMMORTALITY_EKIMUS);
	...
	protected int enterInstance(L2PcInstance player, String template, int[] coords)
	{
		...
		else
		{
			for (L2PcInstance partyMember : player.getParty().getCommandChannel().getMembers())
			{
				...
				if (partyMember.getQuestState(HeartOfInfinityAttack.class.getSimpleName()) == null)
				{
		...
		L2Npc npc = addSpawn(DESTROYED_TUMOR[1], -179376, 206111, -15538, 16384, false, 0, false, ((HIAWorld) world).getInstanceId());
		((HIAWorld) world).startroom.add(npc);
		
		return instanceId;
	}
	
	protected void notifyEkimusEntrance(final HIAWorld world)
	{
		if (conquestBegun)
		{
			return;
	...
	protected void conquestBegins(HIAWorld world)
	{
		...
		for (int[] spawn : TUMORS_OF_DEATH_SPAWN)
		{
		...
		for (int[] spawn : MOBS_OF_ROOMS_SPAWN)
		{
			for (int i = 0; i < spawn[6]; i++)
			{
				L2Npc npc = addSpawn(spawn[0], spawn[1], spawn[2], spawn[3], spawn[4], false, 0, false, world.getInstanceId());
		...
		world.ekimus = addSpawn(LORD_OF_IMMORTALITY_EKIMUS, -179537, 208854, -15504, 16384, false, 0, false, world.getInstanceId());
		...
		world.feralHounds.add(addSpawn(FERAL_HOUND_OF_THE_NETHERWORLD, -179224, 209624, -15504, 16384, false, 0, false, world.getInstanceId()));
		world.feralHounds.add(addSpawn(FERAL_HOUND_OF_THE_NETHERWORLD, -179880, 209464, -15504, 16384, false, 0, false, world.getInstanceId()));
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (tmpworld instanceof HIAWorld)
		{
			...
			if (event.startsWith("warpekimus"))
			{
				...
				{
					if (partyMember.isInsideRadius(npc, 800, true, false))
					{
						partyMember.teleToLocation(-179548, 209584, -15504, true);
					}
				}
				notifyEkimusEntrance(world);
			}
			else if (event.startsWith("reenterekimus"))
			{
				player.destroyItemByItemId("SOI", TEAR_OF_A_FREED_SOUL, 3, player, true);
				for (L2PcInstance partyMember : player.getParty().getMembers())
				{
					if (partyMember.isInsideRadius(npc, 400, true, false))
					{
						partyMember.teleToLocation(-179548, 209584, -15504, true);
					}
				}
	...
	{
		QuestState st = player.getQuestState(HeartOfInfinityAttack.class.getSimpleName());
		if (st == null)
		{
			st = newQuestState(player);
		}
		
		if (npc.getId() == GATEKEEPER_OF_ABYSS)
		{
			enterInstance(player, "HeartOfInfinityAttack.xml", ENTER_TELEPORT);
		}
		return "";
	}
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon, Skill skill)
	{
		...
		if (tmpworld instanceof HIAWorld)
		{
			...
			if (!world.isBossAttacked)
			{
				...
				for (L2Npc mob : world.feralHounds)
				{
					((L2MonsterInstance) mob).addDamageHate(attacker, 0, 500);
					((L2MonsterInstance) mob).setRunning();
					((L2MonsterInstance) mob).getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK, attacker);
				}
			}
		}
	...
	public final String onSpawn(L2Npc npc)
	{
		...
		if (tmpworld instanceof HIAWorld)
		{
			...
			if (npc.getId() == DESTROYED_TUMOR[0])
			{
				world.addTag(1);
			}
			
			if (npc.getId() == LORD_OF_IMMORTALITY_EKIMUS)
			{
				handleEkimusStats(world);
			}
			
			if (npc.getId() == FERAL_HOUND_OF_THE_NETHERWORLD)
			{
				for (L2Npc hound : world.feralHounds)
				{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (tmpworld instanceof HIAWorld)
		{
			...
			if (npc.getId() == TUMOR_OF_DEATH)
			{
				...
				npc.deleteMe();
				world.deadTumor = addSpawn(DESTROYED_TUMOR[0], loc.getX(), loc.getY(), loc.getZ(), 0, false, 0, false, world.getInstanceId());
				...
				if (world.tumorCount < 1)
				{
					for (L2Npc hound : world.feralHounds)
					{
						((L2MonsterInstance) hound).abortAttack();
						((L2MonsterInstance) hound).abortCast();
						((L2MonsterInstance) hound).getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
					}
			...
			if ((npc.getId() == SOUL_COFFIN[0]) || (npc.getId() == SOUL_COFFIN[1]))
			{
	...
	private class TumorRevival implements Runnable
	{
		...
		public void run()
		{
			...
			L2Npc alivetumor = addSpawn(TUMOR_OF_DEATH, _deadTumor.getLocation().getX(), _deadTumor.getLocation().getY(), _deadTumor.getLocation().getZ(), 0, false, 0, false, _world.getInstanceId());
	...
	protected void notifyTumorRevival(HIAWorld world)
	{
		if (world.tumorCount == 1)
		{
			...
			for (L2Npc mob : world.feralHounds)
			{
				for (int objId : world.getAllowed())
				{
					L2PcInstance attacker = L2World.getInstance().getPlayer(objId);
					((L2MonsterInstance) mob).addDamageHate(attacker, 0, 500);
					((L2MonsterInstance) mob).setRunning();
					((L2MonsterInstance) mob).getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK, attacker);
				}
	...
	private class RegenerationCoffinSpawn implements Runnable
	{
		...
		public void run()
		{
			...
			for (int i = 0; i < 4; i++)
			{
				L2Npc soulCoffin = addSpawn(SOUL_COFFIN[0], _deadTumor.getLocation().getX(), _deadTumor.getLocation().getY(), _deadTumor.getLocation().getZ(), 0, true, 0, false, _world.getInstanceId());
	...
	private void handleEkimusStats(HIAWorld world)
	{
		...
		world.ekimus.addStatFunc(new FuncSet(Stats.POWER_ATTACK, 0x30, this, world.ekimus.getTemplate().getBasePAtk() * 3, null));
		world.ekimus.addStatFunc(new FuncSet(Stats.MAGIC_ATTACK, 0x30, this, world.ekimus.getTemplate().getBaseMAtk() * 10, null));
		world.ekimus.addStatFunc(new FuncSet(Stats.POWER_DEFENCE, 0x30, this, world.ekimus.getTemplate().getBasePDef() * a[1], null));
		world.ekimus.addStatFunc(new FuncSet(Stats.MAGIC_DEFENCE, 0x30, this, world.ekimus.getTemplate().getBaseMDef() * a[0], null));
		world.ekimus.addStatFunc(new FuncSet(Stats.REGENERATE_HP_RATE, 0x30, this, world.ekimus.getTemplate().getBaseHpReg() * a[2], null));
	}
	...
	{
		for (L2PcInstance players : ZoneManager.getInstance().getZoneById(ZONE_ID).getPlayersInside())
		{
			if (players != null)
			{
				players.teleToLocation(-179537, 211233, -15472, true);
			}
		}
