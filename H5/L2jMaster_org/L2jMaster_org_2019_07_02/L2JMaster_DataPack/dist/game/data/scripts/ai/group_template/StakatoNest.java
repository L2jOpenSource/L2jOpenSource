...
public final class StakatoNest extends AbstractNpcAI
{
	...
	private static final SkillHolder EATING_FOLLOWER = new SkillHolder(4484);
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon)
	{
		...
		{
			final L2MonsterInstance follower = checkMinion(npc);
			
			if ((follower != null) && (mob != follower))
			{
				...
				if (hp > (follower.getMaxHp() * 0.3))
				{
					...
					mob.doCast(EATING_FOLLOWER);
					startQuestTimer("eatingFollowerHealDelay", 3000, follower, attacker);
				}
			}
		}
	...
	public final String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "male_change":
				...
				break;
			case "eatingFollowerHealDelay":
				final L2MonsterInstance follower = (L2MonsterInstance) npc;
				final L2MonsterInstance mob = follower.getLeader();
				mob.setTarget(mob);
