			...
			switch (npc.getId())
			{
				...
				case MARSH_STAKATO_DRONE:
				{
					if (hasQuestItems(killer, IXIAS_LIST) && (getQuestItemsCount(killer, NIGHTSHADE_ROOT) < 10))
					{
						...
						{
							giveItems(killer, NIGHTSHADE_ROOT, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case MEDUSA:
				{
					if (hasQuestItems(killer, IXIAS_LIST) && (getQuestItemsCount(killer, MEDUSAS_ICHOR) < 10))
					{
						...
						{
							giveItems(killer, MEDUSAS_ICHOR, 1 * (int) Config.RATE_QUEST_DROP);
							playSound(killer, Sound.ITEMSOUND_QUEST_ITEMGET);
						}
					}
					break;
				...
				case TYRANT_KINGPIN:
				{
					if (hasQuestItems(killer, IXIAS_LIST) && (getQuestItemsCount(killer, TYRANTS_BLOOD) < 10))
					{
						...
						{
							giveItems(killer, TYRANTS_BLOOD, 1 * (int) Config.RATE_QUEST_DROP);
							playSound(killer, Sound.ITEMSOUND_QUEST_ITEMGET);
						}
					}
					break;
				...
				case DEAD_SEEKER:
				{
					if (hasQuestItems(killer, IXIAS_LIST) && (getQuestItemsCount(killer, DEAD_SEEKER_DUNG) < 10))
					{
						...
						{
							giveItems(killer, DEAD_SEEKER_DUNG, 1 * (int) Config.RATE_QUEST_DROP);
							playSound(killer, Sound.ITEMSOUND_QUEST_ITEMGET);
						}
					}
					break;
				...
				case MARSH_SPIDER:
				{
					if (hasQuestItems(killer, IXIAS_LIST) && (getQuestItemsCount(killer, MARSH_SPIDER_FLUIDS) < 10))
					{
						...
						{
							giveItems(killer, MARSH_SPIDER_FLUIDS, 1 * (int) Config.RATE_QUEST_DROP);
							playSound(killer, Sound.ITEMSOUND_QUEST_ITEMGET);
						}
					}
					break;
