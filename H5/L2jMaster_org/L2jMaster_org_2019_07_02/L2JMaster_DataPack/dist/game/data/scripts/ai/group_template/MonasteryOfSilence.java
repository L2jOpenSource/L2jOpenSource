...
public final class MonasteryOfSilence extends AbstractNpcAI
{
	...
	private static final int DISCIPLE = 22792; // Disciple Solina
	...
	private MonasteryOfSilence()
	{
		...
		addNpcHateId(GUIDE, SEEKER, SAVIOR, DISCIPLE, ASCETIC);
		addAggroRangeEnterId(GUIDE, SEEKER, SAVIOR, DISCIPLE, ASCETIC);
