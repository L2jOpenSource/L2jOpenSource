			...
			switch (npc.getId())
			{
				case LESSER_DARK_HORROR:
				{
					if (hasQuestItems(killer, ANIMAL_SLAYERS_3RD_LIST) && (getQuestItemsCount(killer, BLOODY_NAIL) < 50))
					{
						if (getRandom(100) < 60)
						{
							giveItems(killer, BLOODY_NAIL, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case GIANT_SPIDER:
				{
					if (hasQuestItems(killer, ANIMAL_SLAYERS_1ST_LIST))
					{
						...
						{
							giveItems(killer, BLOODY_FANG, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case HOOK_SPIDER:
				{
					if (hasQuestItems(killer, ANIMAL_SLAYERS_2ND_LIST))
					{
						...
						{
							giveItems(killer, BLOODY_CLAW, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case HUNTER_TARANTULA:
				{
					if (hasQuestItems(killer, ANIMAL_SLAYERS_5TH_LIST))
					{
						...
						{
							giveItems(killer, BLOODY_TARANTULA_NAIL, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case KASHA_SPIDER:
				{
					if (hasQuestItems(killer, ANIMAL_SLAYERS_4TH_LIST))
					{
						...
						{
							giveItems(killer, BLOODY_KASHA_FANG, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case CRIMSON_SPIDER2:
				{
					if (hasQuestItems(killer, ANIMAL_SLAYERS_LIST))
					{
						...
						{
							giveItems(killer, BLOODY_RED_CLAW, 1 * (int) Config.RATE_QUEST_DROP);
