...
public class SummonMinions extends AbstractNpcAI
{
	...
	private static Set<Integer> MY_TRACKING_SET = ConcurrentHashMap.newKeySet();
	private final HashMap<Integer, ArrayList<L2PcInstance>> _attackersList = new HashMap<>();// shared();
