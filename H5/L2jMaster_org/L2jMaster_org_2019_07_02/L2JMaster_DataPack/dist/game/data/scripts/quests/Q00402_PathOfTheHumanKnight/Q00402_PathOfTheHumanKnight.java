		...
		if ((qs != null) && qs.isStarted() && Util.checkIfInRange(1500, npc, killer, true))
		{
			switch (npc.getId())
			{
				...
				case LANGK_LIZARDMAN:
				{
					...
					{
						giveItems(killer, LIZARDMANS_TOTEM, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case BLADE_SPIDER:
				{
					...
					{
						giveItems(killer, GIANT_SPIDERS_HUSK, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case SILENT_HORROR:
				{
					...
					{
						giveItems(killer, SKULL_OF_SILENT_HORROR, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case BUGBEAR_RAIDER:
				{
					...
					{
						giveItems(killer, BUGBEAR_NECKLACE, 1 * (int) Config.RATE_QUEST_DROP);
				...
				case UNDEAD_PRIEST:
				{
					...
					{
						giveItems(killer, EINHASAD_CRUCIFIX, 1 * (int) Config.RATE_QUEST_DROP);
