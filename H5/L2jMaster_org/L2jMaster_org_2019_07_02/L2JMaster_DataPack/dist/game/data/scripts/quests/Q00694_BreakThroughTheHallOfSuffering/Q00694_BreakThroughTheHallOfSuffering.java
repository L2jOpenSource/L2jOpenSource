...
/**
 * Break Through The Hall Of Suffering (694)
...
public final class Q00694_BreakThroughTheHallOfSuffering extends Quest
{
	...
	// Items
	private static final int MARK = 13691; // Mark of Keucereus - Stage 1
					...
					case TEPIOS2:
						...
						if ((world != null) && (world.getTemplateId() == INSTANCE_ID))
						{
							...
							else if ((player.getParty() != null) && (player.getParty().getLeaderObjectId() == player.getObjectId()))
							{
								...
								{
									QuestState st1 = member.getQuestState(Q00694_BreakThroughTheHallOfSuffering.class.getSimpleName());
									if (st1 != null)
									{
										if (world.tag == 13777)
										{
