...
public class ZoneTemplate extends StatTemplate
{
	...
	private boolean _isSpecialPvP;
	private int _pvp_level_max;
	private int _pvp_level_min;
	...
	public ZoneTemplate(StatsSet set)
	{
		...
		_isSpecialPvP = set.getBool("SpecialPvP", false);
		
		_pvp_level_min = set.getInteger("PvPLevelMin", 1);
		_pvp_level_max = set.getInteger("PvPLevelMax", 85);
		
		_index = set.getInteger("index", 0);
		_taxById = set.getInteger("taxById", 0);

		_spawnRate = set.getInteger("spawn_rate", 1);
	...
	public boolean isSpecialPvP()
	{
		return _isSpecialPvP;
	}	

	public int getPvPLevelMin()
	{
		return _pvp_level_min;
	}	

	public int getPvPLevelMax()
	{
		return _pvp_level_max;
	}		
