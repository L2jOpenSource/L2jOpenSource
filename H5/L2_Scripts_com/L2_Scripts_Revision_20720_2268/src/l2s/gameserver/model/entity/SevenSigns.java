...
import l2s.gameserver.instancemanager.AutoSpawnManager.AutoSpawnInstance;
...
public class SevenSigns
{
	...
	/**
	 * Возвращает true если данная дата входит в Период Валидации Печатей или в Quest Event Results периоде
	 * 
	 * @param date
	 * @return
	 */
	...
	public class SevenSignsPeriodChange extends RunnableImpl
	{
		public void runImpl() throws Exception
		{
			...
			try
			{
				...
				getListenerEngine().onPeriodChange();
				SSQInfoPacket ss = new SSQInfoPacket();
				for(Player player : GameObjectsStorage.getAllPlayersForIterate())
