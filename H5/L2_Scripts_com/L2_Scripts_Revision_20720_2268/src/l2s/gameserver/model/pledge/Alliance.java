...
public class Alliance
{
	...
	public static long EXPELLED_MEMBER_PENALTY = Config.ALLY_EXPELLED_MEMBER_PENALTY * 60 * 60 * 1000L; // 24
	...
	{
		return getAllyCrestId(null);
	}	
	
	public int getAllyCrestId(Player player)
	{
		if(player == null)
			return _allyCrestId; //not from the packet
