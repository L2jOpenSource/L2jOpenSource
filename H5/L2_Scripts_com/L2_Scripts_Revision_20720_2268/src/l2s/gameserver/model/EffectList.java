...
public class EffectList
{
	...
	public static final int DEBUFF_LIMIT	=	Config.DEBUFF_LIMIT; //8
	public static final int MUSIC_LIMIT		=	Config.MUSIC_LIMIT; // 12
	public static final int TRIGGER_LIMIT	=	Config.TRIGGER_LIMIT; //12
	...
	public List<Effect> getEffectsByType(EffectType et)
	{
		if(isEmpty())
	...
	public void addEffect(Effect effect)
	{
		...
		_actor.getListeners().onEffectAdd(effect);
	}
	...
	public void removeEffect(Effect effect)
	{
		...
		_actor.updateStats();
		_actor.updateEffectIcons();
		_actor.getListeners().onEffectRemove(effect);
	}
