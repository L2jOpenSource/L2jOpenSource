	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			for(Iterator<Element> subIterator = element.elementIterator(); subIterator.hasNext();)
			{
				...
				{
					resetReuse = subElement.attributeValue("resetReuse") != null ? new SchedulingPattern(subElement.attributeValue("resetReuse")) : resetReuse;
					reuseDelay = subElement.attributeValue("delay") != null ? Integer.parseInt(subElement.attributeValue("delay")) : reuseDelay;
			...
			InstantZone instancedZone = new InstantZone(instanceId, name, resetReuse, reuseDelay, sharedReuseGroup, timelimit, dispelBuffs, minLevel, maxLevel, minParty, maxParty, timer, onPartyDismiss, teleportLocs, ret, doors, zones, spawns2,  spawns, collapseIfEmpty, maxChannels, removedItemId, removedItemCount, removedItemNecessity, giveItemId, givedItemCount, requiredQuestId, setReuseUponEntry, params);
