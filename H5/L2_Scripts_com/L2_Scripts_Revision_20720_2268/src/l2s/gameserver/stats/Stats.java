...
public enum Stats
{
	...
	RUN_SPEED_LIMIT("RUN_SPEED_LIMIT", 0., Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY),
	...
	PVP_BOW_DMG_BONUS("pvpBowDmgBonus"),
	PVP_BOW_SKILL_DMG_BONUS("pvpBowSkillDmgBonus"),
	PVP_BOW_DEFENCE_BONUS("pvpBowDefenceBonus"),
	PVP_BOW_SKILL_DEFENCE_BONUS("pvpBowSkillDefenceBonus"),

	PVE_BOW_DMG_BONUS("pveBowDmgBonus"),
	PVE_BOW_SKILL_DMG_BONUS("pveBowSkillDmgBonus"),
	PVE_BOW_DEFENCE_BONUS("pveBowDefenceBonus"),
	PVE_BOW_SKILL_DEFENCE_BONUS("pveBowSkillDefenceBonus"),

	HEAL_EFFECTIVNESS("hpEff", 0., 1000.),
	MANAHEAL_EFFECTIVNESS("mpEff", 0., 1000.),
	MANAHEAL_BONUS("mpHealBonus", 0., 1000.),  
