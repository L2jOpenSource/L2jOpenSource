...
public class Strings
{
	...
	public static void reload()
	{
		try
		{
			String[] pairs = FileUtils.readFileToString(new File(Config.DATAPACK_ROOT, "data/translit.txt"), "UTF-8").split("\n");
			...
			pairs = FileUtils.readFileToString(new File(Config.DATAPACK_ROOT, "data/translit_back.txt"), "UTF-8").split("\n");
			...
			pairs = FileUtils.readFileToString(new File(Config.DATAPACK_ROOT, "data/transcode.txt"), "UTF-8").split("\n");
