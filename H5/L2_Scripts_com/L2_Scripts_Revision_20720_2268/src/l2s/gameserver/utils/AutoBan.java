...
public final class AutoBan
{
	...
	public static boolean ChatBan(String actor, int period, String msg, String GM)
	{
		...
		if(plyr != null)
		{
			...
			plyr.sendMessage(new CustomMessage("l2s.Util.AutoBan.ChatBan", plyr).addString(GM).addNumber(period));
	...
	public static boolean ChatUnBan(String actor, String GM)
	{
		...
		if(plyr != null)
		{
			plyr.sendMessage(new CustomMessage("l2s.Util.AutoBan.ChatUnBan", plyr).addString(GM));
	...
	public static void doJailPlayer(String playerName, int period, boolean msg)
	{
