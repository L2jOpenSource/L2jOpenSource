...
public final class WarehouseFunctions
{
	...
	public static void showFreightWindow(Player player)
	{
		...
		player.sendPacket(new WareHouseWithdrawListPacket(1, player, WarehouseType.FREIGHT, ItemClass.ALL));
		player.sendPacket(new WareHouseWithdrawListPacket(2, player, WarehouseType.FREIGHT, ItemClass.ALL));
	}
	...
	public static void showRetrieveWindow(Player player, int val)
	{
		...
		player.sendPacket(new WareHouseWithdrawListPacket(1, player, WarehouseType.PRIVATE, ItemClass.values()[val]));
		player.sendPacket(new WareHouseWithdrawListPacket(2, player, WarehouseType.PRIVATE, ItemClass.values()[val]));
	}
	...
	public static void showWithdrawWindowClan(Player player, int val)
	{
		...
		player.setUsingWarehouseType(WarehouseType.CLAN);
		player.sendPacket(new WareHouseWithdrawListPacket(1, player, WarehouseType.CLAN, ItemClass.values()[val]));
		player.sendPacket(new WareHouseWithdrawListPacket(2, player, WarehouseType.CLAN, ItemClass.values()[val]));
	}
