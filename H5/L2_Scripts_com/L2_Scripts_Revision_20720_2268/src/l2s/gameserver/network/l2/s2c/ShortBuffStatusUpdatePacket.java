...
public class ShortBuffStatusUpdatePacket extends L2GameServerPacket
{
	...
	public ShortBuffStatusUpdatePacket(Effect effect)
	{
	...
	protected final void writeImpl()
	{
		...
		writeD(SkillUtils.convertHFSkillLevelToGODMask(_skillId, _skillLevel)); //Skill Level??? 07 00 00 00 = casted by heal 7 lvl.
