...
public class L2FriendPacket extends L2GameServerPacket
{
	private boolean _add, _online;
	private String _name;
	private int _object_id;

	public L2FriendPacket(Player player, boolean add)
	{
		_add = add;
	...
	public L2FriendPacket(String name, boolean add, boolean online, int object_id)
	{
		_name = name;
		_add = add;
