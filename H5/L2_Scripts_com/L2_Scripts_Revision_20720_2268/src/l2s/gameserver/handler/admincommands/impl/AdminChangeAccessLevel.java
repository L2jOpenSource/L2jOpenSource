...
public class AdminChangeAccessLevel implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_moders_add:
				...
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.IncorrectPlayer", activeChar));
					showModersPannel(activeChar);
					return false;
				}
				...
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.IncorrectModerator", activeChar).addString(modAdd.getName()));
					showModersPannel(activeChar);
					return false;
				}
				...
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.ErrorParsing", activeChar));
					showModersPannel(activeChar);
					return false;
				}
				...
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.ErrorModify", activeChar));
				...
				if(!af.exists())
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.ErrorModifyModerator", activeChar).addString(modAdd.getName()));
					showModersPannel(activeChar);
					return false;
				}
				...
				activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.AddModerator", activeChar).addString(modAdd.getName()));
				showModersPannel(activeChar);
				break;
			case admin_moders_del:
				if(wordList.length < 2)
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.DeleteError", activeChar));
					showModersPannel(activeChar);
					return false;
				}
				...
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.NotFoundOID", activeChar).addNumber(oid));
					showModersPannel(activeChar);
					return false;
				}
				...
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.ErrorDeleteFile", activeChar).addString(fname));
					showModersPannel(activeChar);
					return false;
				}

				if(modDel != null)
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.DeleteSuccessByName", activeChar).addString(modDel.getName()));
				else
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.DeleteSuccessByOID", activeChar).addNumber(oid));
			...
			case admin_penalty:
				if(wordList.length < 2)
				{
					activeChar.sendMessage(new CustomMessage("common.Admin.AccessLevel.PenaltyUssage", activeChar));
					return false;
				}
	...
	{
		NpcHtmlMessagePacket reply = new NpcHtmlMessagePacket(5);
