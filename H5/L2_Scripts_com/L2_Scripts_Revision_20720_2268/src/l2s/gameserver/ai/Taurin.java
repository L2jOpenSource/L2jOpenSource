		...
		if(System.currentTimeMillis() > wait_timeout && (current_point > -1 || Rnd.chance(5)))
		{
			if(!wait)
			{
				switch(current_point)
				{
					...
					case 30:
						wait_timeout = System.currentTimeMillis() + 10000;
						Functions.npcShoutCustomMessage(actor, "Всем лежать, у меня бомба!");
						wait = true;
						return true;
					case 31:
						wait_timeout = System.currentTimeMillis() + 15000;
						Functions.npcShoutCustomMessage(actor, "Я больной, за себя не ручаюсь!!!!");
						wait = true;
						return true;
					case 32:
						wait_timeout = System.currentTimeMillis() + 15000;
						Functions.npcShoutCustomMessage(actor, "Вы все еще тут? Я вас предупреждал!!!!!");
						wait = true;
						return true;
					case 33:
						actor.broadcastPacket(new MagicSkillUse(actor, actor, 2025, 1, 500, 0));
			...
			addTaskMove(points[current_point], true, false);
			doTask();
			return true;
		}
