...
public class AndreasVanHalter extends Fighter
{
	...
	protected boolean thinkActive()
	{
		...
		if( !door1.isOpen() && !door2.isOpen() && door3.isOpen() && door4.isOpen() && _firstTimeMove)
		{
			...
			// Запускаем музыку
			actor.broadcastPacket(new PlaySoundPacket("BS04_A"));
		...
		public void runImpl()
		{
			...
			switch(_taskId)
			{
				case 1:
					...
					actor.doCast(SkillHolder.getInstance().getSkill(1168, 7), npc1, false);
				...
				case 2:
					...
					npc2.sendPacket(new SocialActionPacket(npc2.getObjectId(), 1));
					// Стави жертве ХП 0
