...
public class ElcardiaAssistant extends DefaultAI
{
	...
	private final Skill vampRage = SkillHolder.getInstance().getSkill(6727, 1);
	private final Skill holyResist = SkillHolder.getInstance().getSkill(6729, 1);
	private final Skill blessBlood = SkillHolder.getInstance().getSkill(6725, 1);
	private final Skill recharge = SkillHolder.getInstance().getSkill(6728, 1);
	private final Skill heal = SkillHolder.getInstance().getSkill(6724, 1);
