				...
				if(playerCabal == winningCabal && actor.getNpcId() == SevenSigns.ORATOR_NPC_ID)
				{
					if(player.isMageClass())
					{
						...
						if(effects == null || effects.size() <= 0)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(ORATOR_MAGE_SKILL_ID, 1);
							if(skill != null)
						...
						else if(i0 < 5)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(ORATOR_MAGE_SKILL_ID, 2);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
					}
					else
					{
						...
						if(effects == null || effects.size() <= 0)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(ORATOR_FIGHTER_SKILL_ID, 1);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
						else if(i0 < 5)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(ORATOR_FIGHTER_SKILL_ID, 2);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
					}
				...
				else if(playerCabal == losingCabal && actor.getNpcId() == SevenSigns.PREACHER_NPC_ID)
				{
					if(player.isMageClass())
					{
						...
						if(effects == null || effects.size() <= 0)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(PREACHER_MAGE_SKILL_ID, 1);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
						else if(i0 < 5)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(PREACHER_MAGE_SKILL_ID, 2);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
					}
					else
					{
						...
						if(effects == null || effects.size() <= 0)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(PREACHER_FIGHTER_SKILL_ID, 1);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
						else if(i0 < 5)
						{
							...
							Skill skill = SkillHolder.getInstance().getSkill(PREACHER_FIGHTER_SKILL_ID, 2);
							if(skill != null)
								actor.altUseSkill(skill, player);
						}
					}
