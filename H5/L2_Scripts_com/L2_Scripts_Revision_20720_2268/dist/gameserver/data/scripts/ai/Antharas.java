...
public class Antharas extends DefaultAI
{
	...
	private static final int FWA_INTERVAL_MINION_WEAK = 3 * 60000;
	private static final int FWA_INTERVAL_MINION_NORMAL = 3 * 60000;
	private static final int FWA_INTERVAL_MINION_STRONG = 3 * 60000;
	...
	protected boolean createNewTask()
	{
		...
		{
			NpcInstance minion = Functions.spawn(Location.findPointToStay(actor.getLoc(), 400, 700, actor.getGeoIndex()), Rnd.chance(50) ? 29190 : 29069, actor.getReflection());  // Antharas Minions
			minions.add(minion);
			if(actor.getReflection() == ReflectionManager.DEFAULT)
