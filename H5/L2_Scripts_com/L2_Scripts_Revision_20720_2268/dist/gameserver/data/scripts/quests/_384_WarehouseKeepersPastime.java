...
public class _384_WarehouseKeepersPastime extends QuestScript
{
	// NPCs
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if((event.equalsIgnoreCase("30182-08.htm") || event.equalsIgnoreCase("30685-08.htm")))
		{
			st.finishQuest();
		}
		else if(event.contains("-game"))
		{
	...
	public String onKill(NpcInstance npc, QuestState qs)
	{
		...
		{
			qs.giveItems(Warehouse_Keepers_Medal, 1, true, true);
	...
	public static class Bingo extends quests.Bingo
	{
		...
		private final static String template_choice = "<a action=\"bypass -h npc_%objectId%_QuestEvent 384 choice-%n%\">%n%</a>&nbsp;&nbsp;&nbsp;&nbsp;  ";
		...
		private void reward(int[][] rew)
		{
			...
			for(int[] l : rew)
				if(r < l[0])
				{
					_qs.giveItems(l[1], l[2], false, false);
					return;
				}
		}
	}
