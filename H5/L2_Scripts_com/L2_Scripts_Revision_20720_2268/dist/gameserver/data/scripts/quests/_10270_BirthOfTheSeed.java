 ...
 * @date: 09.06.2010
 */
public class _10270_BirthOfTheSeed extends QuestScript
{
	// NPC's
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equals("reward") && cond == 5)
		{
			...
			st.giveItems(ADENA_ID, 41677, true, true);
