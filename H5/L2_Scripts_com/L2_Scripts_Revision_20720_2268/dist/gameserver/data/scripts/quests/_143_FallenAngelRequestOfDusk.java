...
public class _143_FallenAngelRequestOfDusk extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(2);
			st.giveItems(SEALED_PATH, 1, false, false);
		}
		else if(event.equalsIgnoreCase("master_tobias_q0143_05.htm"))
		{
			st.setCond(3);
			st.unset("talk");
			st.giveItems(PATH, 1, false, false);
		...
		else if(event.equalsIgnoreCase("q_fallen_angel_npc_q0143_14.htm"))
		{
			...
			st.giveItems(MESSAGE, 1, false, false);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == TOBIAS)
		{
			...
			else if(cond == 5)
			{
				...
				st.giveItems(ADENA_ID, 89046, true, true);
