...
public class _402_PathToKnight extends QuestScript
{
	//npc
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("quilt_q0402_02.htm"))
		{
			...
			if(squire > 0 && coin1 + coin2 + coin3 + coin4 + coin5 + coin6 >= 3)
			{
				...
				{
					st.giveItems(SWORD_OF_RITUAL, 1, false, false);
		...
		else if(npcId == BATHIS && cond == 1 && squire > 0)
		{
			...
			else if(guards_mark1 > 0)
			{
				...
				else
				{
					...
					st.giveItems(COIN_OF_LORDS1, 1, false, false);
		...
		else if(npcId == RAYMOND && cond == 1 && squire > 0)
		{
			...
			else if(church_mark1 > 0)
			{
				...
				else
				{
					...
					st.giveItems(COIN_OF_LORDS2, 1, false, false);
					st.playSound(SOUND_MIDDLE);
				}
			}
			else if(coin2 > 0)
		...
		else if(npcId == BEZIQUE && cond == 1 && squire > 0)
		{
			...
			else if(guards_mark2 > 0)
			{
				...
				else
				{
					...
					st.giveItems(COIN_OF_LORDS3, 1, false, false);
					st.playSound(SOUND_MIDDLE);
				}
			}
			else if(coin3 > 0)
		...
		else if(npcId == LEVIAN && cond == 1 && squire > 0)
		{
			...
			else if(church_mark2 > 0)
			{
				...
				else
				{
					...
					st.giveItems(COIN_OF_LORDS4, 1, false, false);
					st.playSound(SOUND_MIDDLE);
				}
			}
			else if(coin4 > 0)
		...
		else if(npcId == GILBERT && cond == 1 && squire > 0)
		{
			...
			else if(guards_mark3 > 0)
			{
				...
				else
				{
					...
					st.giveItems(COIN_OF_LORDS5, 1, false, false);
					st.playSound(SOUND_MIDDLE);
				}
			}
			else if(coin5 > 0)
		...
		else if(npcId == BIOTIN && cond == 1 && squire > 0)
		{
			...
			else if(church_mark3 > 0)
			{
				...
				else
				{
					...
					st.giveItems(COIN_OF_LORDS6, 1, false, false);
					st.playSound(SOUND_MIDDLE);
				}
			}
			else if(coin6 > 0)
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		for(int[] element : DROPLIST)
			...
			{
				st.giveItems(element[2], 1, true, true);
