...
public class _621_EggDelivery extends QuestScript
{
	//NPC
	...
	private static void takeEgg(QuestState st, int setcond)
	{
		...
		st.giveItems(FeeOfBoiledEgg, 1, false, false);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("jeremy_q0621_0104.htm"))
		{
			st.takeItems(BoiledEgg, -1);
			st.takeItems(FeeOfBoiledEgg, -1);
			st.setCond(1);
			st.giveItems(BoiledEgg, 5, false, false);
		}
