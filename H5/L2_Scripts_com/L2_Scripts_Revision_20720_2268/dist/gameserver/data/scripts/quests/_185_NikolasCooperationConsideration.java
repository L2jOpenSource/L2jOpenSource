...
public class _185_NikolasCooperationConsideration extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(1);
			st.giveItems(NicolasMap, 1, false, false);
		}
		...
		else if(event.equalsIgnoreCase("30673-09.htm"))
		{
			if(st.getQuestItemsCount(BrokenMetal) > 0)
				...
				st.giveItems(Certificate, 1, false, false);
			st.giveItems(ADENA_ID, 72527, true, true);
