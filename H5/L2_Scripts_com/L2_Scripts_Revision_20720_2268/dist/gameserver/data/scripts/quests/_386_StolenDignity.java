...
public class _386_StolenDignity extends QuestScript
{
	// NPCs
	...
	public static class Bingo extends quests.Bingo
	{
		...
		private final static String template_choice = "<a action=\"bypass -h npc_%objectId%_QuestEvent 386 choice-%n%\">%n%</a>&nbsp;&nbsp;&nbsp;&nbsp;  ";
		...
		private void reward(int[][] rew)
		{
			...
			_qs.giveItems(r[0], r[1], false, false);
		}
	}
}