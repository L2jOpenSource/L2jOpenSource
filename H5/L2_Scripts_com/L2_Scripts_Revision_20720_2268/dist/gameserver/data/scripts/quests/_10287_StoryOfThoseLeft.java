...
public class _10287_StoryOfThoseLeft extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.startsWith("exgivebook"))
		{
			...
			{
				case 1:
					st.giveItems(10549, 1, false, false);
					break;
				case 2:
					st.giveItems(10550, 1, false, false);
					break;
				case 3:
					st.giveItems(10551, 1, false, false);
					break;
				case 4:
					st.giveItems(10552, 1, false, false);
					break;
				case 5:
					st.giveItems(10553, 1, false, false);
					break;
				case 6:
					st.giveItems(14219, 1, false, false);
					break;
			}
			st.finishQuest();
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Rafforty)
		{
			if(cond == 0)
			{
				if(st.getPlayer().getLevel() >= 82 && st.getPlayer().isQuestCompleted(10286))
