 ...
 * @date 02/06/2011
 */
public class _10292_SevenSignsGirlOfDoubt extends QuestScript
{
	// NPC
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch(npcId)
		{
			case WOOD:
				if(cond == 0)
				{
					if(player.getLevel() >= 81 && st.getPlayer().isQuestCompleted(198))
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			st.giveItems(ELCARDIAS_MARK, 1, true, true);
