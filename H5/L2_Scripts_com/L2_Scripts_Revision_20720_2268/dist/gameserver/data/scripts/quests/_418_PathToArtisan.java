...
public class _418_PathToArtisan extends QuestScript
{
	//NPC
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("blacksmith_pinter_q0418_06.htm"))
		{
			...
			st.giveItems(SecretBox, 1, false, false);
			st.giveItems(PassCertificate2nd, 1, false, false);
			st.setCond(7);
		}
		else if(event.equalsIgnoreCase("blacksmith_kluto_q0418_10.htm") || event.equalsIgnoreCase("blacksmith_kluto_q0418_12.htm"))
		{
			...
			{
				st.giveItems(FinalPassCertificate, 1, false, false);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Silvera)
		{
			...
			else if(cond == 2)
			{
				...
				st.giveItems(PassCertificate1st, 1, false, false);
