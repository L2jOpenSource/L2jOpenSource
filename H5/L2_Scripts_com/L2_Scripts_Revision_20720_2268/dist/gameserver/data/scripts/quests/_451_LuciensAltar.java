...
public class _451_LuciensAltar extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(1);
			st.giveItems(REPLENISHED_BEAD, 5, false, false);
		}
		return event;
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == DAICHIR)
		{
			...
			else if(cond == 2)
			{
				...
				st.giveItems(ADENA_ID, 127690, true, true);
	...
	private void onAltarCheck(QuestState st)
	{
		...
		st.giveItems(DISCHARGED_BEAD, 1, true, true);
