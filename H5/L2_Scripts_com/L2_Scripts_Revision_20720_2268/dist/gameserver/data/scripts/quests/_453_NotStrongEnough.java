...
public class _453_NotStrongEnough extends QuestScript
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Klemis)
		{
			if(cond == 0)
			{
				if(st.getPlayer().getLevel() >= 84 && st.getPlayer().isQuestCompleted(10282))
			...
			else if(cond == 5)
			{
				...
				st.giveItems(rewardId, 1, false, false);
				st.finishQuest();
			}
		}
		return htmltext;
