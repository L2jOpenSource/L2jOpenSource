...
public class _464_Oath extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("bookowner"))
		{
			...
			st.giveItems(BookofSilence2, 1, false, false);
		}
		else if(event.equalsIgnoreCase("request_reward"))
		{
			...
			st.giveItems(ADENA_ID, Rnd.get(42910, 210806), true, true);
			st.addExpAndSp(Rnd.get(15449, 249180), Rnd.get(17696, 58551));
