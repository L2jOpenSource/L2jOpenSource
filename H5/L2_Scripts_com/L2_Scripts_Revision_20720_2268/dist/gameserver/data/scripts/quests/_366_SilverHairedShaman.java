...
public class _366_SilverHairedShaman extends QuestScript
{
	//NPC
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == 30111)
			...
			{
				st.giveItems(ADENA_ID, (st.getQuestItemsCount(SAIRONS_SILVER_HAIR) * ADENA_PER_ONE) + START_ADENA, true, true);
				st.takeItems(SAIRONS_SILVER_HAIR, -1);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			st.giveItems(SAIRONS_SILVER_HAIR, 1, true, true);
