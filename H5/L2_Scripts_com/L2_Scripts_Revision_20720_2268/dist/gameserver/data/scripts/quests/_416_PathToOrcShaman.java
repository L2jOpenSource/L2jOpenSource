 ...
 */
public class _416_PathToOrcShaman extends QuestScript
{
	//NPC
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.giveItems(FireCharm, 1, false, false);
			st.setCond(1);
		}
		else if(event.equalsIgnoreCase("hestui_totem_spirit_q0416_03.htm"))
		{
			...
			st.giveItems(TotemSpiritClaw, 1, false, false);
			st.setCond(4);
		}
		else if(event.equalsIgnoreCase("tataru_zu_hestui_q0416_11.htm"))
		{
			st.takeItems(TotemSpiritClaw, -1);
			st.giveItems(TatarusLetterOfRecommendation, 1, false, false);
			st.setCond(5);
		}
		...
		else if(event.equalsIgnoreCase("dudamara_totem_spirit_q0416_03.htm"))
		{
			...
			st.giveItems(SpiritNet, 1, false, false);
			st.setCond(9);
		}
		else if(event.equalsIgnoreCase("seer_umos_q0416_07.htm"))
		{
			...
			{
				st.giveItems(MaskOfMedium, 1, false, false);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Hestui)
		{
			...
			else if(cond == 2)
			{
				...
				st.giveItems(HestuiMask, 1, false, false);
				st.giveItems(FieryEgg2nd, 1, false, false);
				st.setCond(3);
			}
			else if(cond == 3)
		...
		else if(npcId == SeerUmos)
		{
			if(cond == 5)
			{
				...
				st.giveItems(FlameCharm, 1, false, false);
			...
			else if(cond == 7)
			{
				...
				st.giveItems(BloodCauldron, 1, false, false);
		...
		else if(npcId == LeopardCarcass)
		{
			...
			else if(cond == 10)
			{
				...
				st.giveItems(TotemSpiritBlood, 1, false, false);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(cond == 9 && (npcId == VenomousSpider || npcId == ArachnidTracker))
		{
			...
			{
				st.giveItems(DurkaParasite, 1, true, true);
		...
		else if(npcId == QuestMonsterDurkaSpirit)
		{
			...
			if(cond == 9)
			{
				...
				st.takeItems(DurkaParasite, -1);
				st.giveItems(BoundDurkaSpirit, 1, false, false);
				st.setCond(10);
			}
		}
