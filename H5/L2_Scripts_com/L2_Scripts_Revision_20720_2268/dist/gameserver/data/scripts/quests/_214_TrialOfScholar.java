...
public class _214_TrialOfScholar extends QuestScript
{
	// NPCs
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.giveItems(Miriens_1st_Sigil, 1, false, false);
			if(!st.getPlayer().getVarBoolean("dd1"))
			{
				st.giveItems(Dimensional_Diamond, 168, false, false);
		...
		{
			st.giveItems(High_Priests_Sigil, 1, false, false);
			st.giveItems(Sylvains_Letter, 1, false, false);
			st.setCond(2);
		}
		else if(event.equalsIgnoreCase("marya_q0214_02.htm"))
		{
			...
			st.giveItems(Marias_1st_Letter, 1, false, false);
			st.setCond(3);
		}
		else if(event.equalsIgnoreCase("astrologer_creta_q0214_05.htm"))
		{
			...
			st.giveItems(Cretas_1st_Letter, 1, false, false);
			st.setCond(6);
		}
		else if(event.equalsIgnoreCase("marya_q0214_08.htm"))
		{
			...
			st.giveItems(Lucillas_Handbag, 1, false, false);
			st.setCond(7);
		}
		else if(event.equalsIgnoreCase("astrologer_creta_q0214_09.htm"))
		{
			...
			st.giveItems(Cretas_Painting1, 1, false, false);
			st.setCond(8);
		}
		else if(event.equalsIgnoreCase("lucas_q0214_04.htm"))
		{
			...
			st.giveItems(Cretas_Painting3, 1, false, false);
			st.setCond(10);
		}
		...
		{
			st.giveItems(Grand_Magisters_Sigil, 1, false, false);
			st.giveItems(Jureks_List, 1, false, false);
			st.setCond(16);
		}
		else if(event.equalsIgnoreCase("magister_mirien_q0214_10.htm"))
		{
			...
			{
				st.giveItems(Miriens_Instruction, 1, false, false);
				return "magister_mirien_q0214_09.htm";
			}
			st.giveItems(Miriens_3rd_Sigil, 1, false, false);
			st.setCond(19);
		}
		else if(event.equalsIgnoreCase("sage_cronos_q0214_10.htm"))
		{
			st.giveItems(Cronos_Sigil, 1, false, false);
			st.giveItems(Cronos_Letter, 1, false, false);
			st.setCond(20);
		}
		else if(event.equalsIgnoreCase("dieter_q0214_05.htm"))
		{
			...
			st.giveItems(Dieters_Key, 1, false, false);
			st.setCond(21);
		}
		else if(event.equalsIgnoreCase("astrologer_creta_q0214_14.htm"))
		{
			...
			st.giveItems(Cretas_2nd_Letter, 1, false, false);
			st.setCond(22);
		}
		else if(event.equalsIgnoreCase("dieter_q0214_09.htm"))
		{
			...
			st.giveItems(Dieters_Letter, 1, false, false);
			st.giveItems(Dieters_Diary, 1, false, false);
			st.setCond(23);
		}
		else if(event.equalsIgnoreCase("trader_edroc_q0214_02.htm"))
		{
			...
			st.giveItems(Rauts_Letter_Envelope, 1, false, false);
			st.setCond(24);
		}
		else if(event.equalsIgnoreCase("warehouse_keeper_raut_q0214_02.htm"))
		{
			...
			st.giveItems(Scripture_Chapter_1, 1, false, false);
			st.giveItems(Strong_Liquor, 1, false, false);
			st.setCond(25);
		}
		...
		else if(event.equalsIgnoreCase("sage_kasian_q0214_07.htm"))
		{
			...
			st.giveItems(Scripture_Chapter_4, 1, false, false);
			st.setCond(30);
		}
		else if(event.equalsIgnoreCase("sage_cronos_q0214_14.htm"))
		{
			...
			st.giveItems(Symbol_of_Cronos, 1, false, false);
			st.setCond(31);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Mirien)
		{
			...
			if(st.getQuestItemsCount(Miriens_1st_Sigil) > 0)
			{
				...
				st.giveItems(Miriens_2nd_Sigil, 1, false, false);
				st.setCond(15);
			...
			if(st.getQuestItemsCount(Miriens_3rd_Sigil) > 0)
			{
				...
				if(!st.getPlayer().getVarBoolean("prof2.1"))
				{
					...
					st.giveItems(ADENA_ID, 319628, true, true);
					st.getPlayer().setVar("prof2.1", "1", -1);
				}
				st.giveItems(Mark_of_Scholar, 1, false, false);
				st.finishQuest();
		...
		if(npcId == Sylvain)
		{
			if(st.getQuestItemsCount(Miriens_1st_Sigil) > 0)
			{
				...
				st.giveItems(Symbol_of_Sylvain, 1, false, false);
				st.setCond(14);
		...
		if(npcId == Lucas)
			if(st.getQuestItemsCount(Miriens_1st_Sigil) > 0 && st.getQuestItemsCount(High_Priests_Sigil) > 0)
			{
				if(st.getQuestItemsCount(Marias_1st_Letter) > 0)
				{
					...
					st.giveItems(Lucass_Letter, 1, false, false);
					st.setCond(4);
		...
		if(npcId == Valkon && st.getQuestItemsCount(Triffs_Ring) > 0)
		{
			...
			else if(Valkons_Request_count == 0 && Scripture_Chapter_2_count == 0)
			{
				...
				st.playSound(SOUND_MIDDLE);
				st.giveItems(Scripture_Chapter_2, 1, false, false);
			...
			if(st.getQuestItemsCount(Miriens_2nd_Sigil) > 0)
			{
				...
				if(st.getQuestItemsCount(Jureks_List) > 0)
				{
					...
					if(Grand_Magisters_Sigil_count > 0)
					{
						...
						st.giveItems(Symbol_of_Jurek, 1, false, false);
						st.setCond(18);
		...
		if(npcId == Poitan && st.getQuestItemsCount(Triffs_Ring) > 0)
		{
			...
			if(st.getQuestItemsCount(Scripture_Chapter_4) == 0)
			{
				...
				{
					st.playSound(SOUND_MIDDLE);
					st.giveItems(Poitans_Notes, 1, false, false);
		...
		if(npcId == Maria)
		{
			if(st.getQuestItemsCount(Miriens_1st_Sigil) > 0 && st.getQuestItemsCount(High_Priests_Sigil) > 0)
			{
				...
				if(st.getQuestItemsCount(Lucass_Letter) > 0)
				{
					...
					st.giveItems(Marias_2nd_Letter, 1, false, false);
					st.setCond(5);
				...
				if(st.getQuestItemsCount(Cretas_Painting1) > 0)
				{
					...
					st.giveItems(Cretas_Painting2, 1, false, false);
					st.setCond(9);
			...
			if(st.getQuestItemsCount(Miriens_3rd_Sigil) > 0)
			{
				...
				st.playSound(SOUND_MIDDLE);
				st.giveItems(Crystal_of_Purity2, 1, false, false);
