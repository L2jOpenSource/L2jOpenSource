...
public class _235_MimirsElixir extends QuestScript
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == LADD)
		{
			...
			else if(cond == 4)
			{
				...
				st.giveItems(TRUE_GOLD, 1, false, false);
				st.setCond(5);
