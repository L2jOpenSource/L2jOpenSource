...
public class _333_BlackLionHunt extends QuestScript
{
	...
	{
		st.giveItems(ADENA_ID, 35 * count, true, true);
		st.takeItems(item, count);
		if(count >= 20)
			st.giveItems(LIONS_CLAW, count / 20, true, true);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.set("part", "1");
			st.giveItems(SOPHIAS_LETTER1, 1, false, false);
			return "30735-02.htm";
		}
		else if(event.equalsIgnoreCase("p2_t"))
		{
			st.set("part", "2");
			st.giveItems(SOPHIAS_LETTER2, 1, false, false);
			return "30735-03.htm";
		}
		else if(event.equalsIgnoreCase("p3_t"))
		{
			st.set("part", "3");
			st.giveItems(SOPHIAS_LETTER3, 1, false, false);
			return "30735-04.htm";
		}
		else if(event.equalsIgnoreCase("p4_t"))
		{
			st.set("part", "4");
			st.giveItems(SOPHIAS_LETTER4, 1, false, false);
			return "30735-05.htm";
		}
		...
		else if(event.equalsIgnoreCase("continue"))
		{
			...
			if(claw > 0)
			{
				st.giveItems(LIONS_EYE, claw, false, false);
				...
				while(claw > 0)
				{
					int n = Rnd.get(5);
					if(n == 0)
						st.giveItems(ALACRITY_POTION, ala_count, false, false);
					else if(n == 1)
						st.giveItems(SOULSHOT_D, soul_count, false, false);
					else if(n == 2)
						st.giveItems(SCROLL_ESCAPE, soe_count, false, false);
					else if(n == 3)
						st.giveItems(SPIRITSHOT_D, spir_count, false, false);
					else if(n == 4)
						st.giveItems(HEALING_POTION, heal_count, false, false);
					claw -= 1;
				}
				if(check_eye > 0)
					return "30735-06.htm";
		...
		else if(event.equalsIgnoreCase("f_give"))
		{
			if(st.getQuestItemsCount(CARGO_BOX1) > 0)
			{
				if(st.getQuestItemsCount(ADENA_ID) >= OPEN_BOX_PRICE)
				{
					...
					if(rand < 21)
					{
						st.giveItems(GLUDIO_APPLE, 1, false, false);
						return "red_foor-02.htm";
					}
					else if(rand < 41)
					{
						st.giveItems(CORN_MEAL, 1, false, false);
						return "red_foor-03.htm";
					}
					else if(rand < 61)
					{
						st.giveItems(WOLF_PELTS, 1, false, false);
						return "red_foor-04.htm";
					}
					else if(rand < 74)
					{
						st.giveItems(MONNSTONE, 1, false, false);
						return "red_foor-05.htm";
					}
					else if(rand < 86)
					{
						st.giveItems(GLUDIO_WEETS_FLOWER, 1, false, false);
						return "red_foor-06.htm";
					}
					else if(rand < 98)
					{
						st.giveItems(SPIDERSILK_ROPE, 1, false, false);
						return "red_foor-07.htm";
					}
					else if(rand < 99)
					{
						st.giveItems(ALEXANDRIT, 1, false, false);
						return "red_foor-08.htm";
					}
					else if(rand < 109)
					{
						st.giveItems(SILVER_TEA, 1, false, false);
						return "red_foor-09.htm";
					}
					else if(rand < 119)
					{
						st.giveItems(GOLEM_PART, 1, false, false);
						return "red_foor-10.htm";
					}
					else if(rand < 123)
					{
						st.giveItems(FIRE_EMERALD, 1, false, false);
						return "red_foor-11.htm";
					}
					else if(rand < 127)
					{
						st.giveItems(SILK_FROCK, 1, false, false);
						return "red_foor-12.htm";
					}
					else if(rand < 131)
					{
						st.giveItems(PORCELAN_URN, 1, false, false);
						return "red_foor-13.htm";
					}
					else if(rand < 132)
					{
						st.giveItems(IMPERIAL_DIAMOND, 1, false, false);
						return "red_foor-13.htm";
					}
					else if(rand < 147)
					{
						...
						if(random_stat == 3)
						{
							st.giveItems(STATUE_SHILIEN_HEAD, 1, false, false);
							return "red_foor-14.htm";
						}
						else if(random_stat == 0)
						{
							st.giveItems(STATUE_SHILIEN_TORSO, 1, false, false);
							return "red_foor-14.htm";
						}
						else if(random_stat == 1)
						{
							st.giveItems(STATUE_SHILIEN_ARM, 1, false, false);
							return "red_foor-14.htm";
						}
						else if(random_stat == 2)
						{
							st.giveItems(STATUE_SHILIEN_LEG, 1, false, false);
							return "red_foor-14.htm";
						}
					}
					else if(rand <= 162)
					{
						...
						if(random_tab == 0)
						{
							st.giveItems(FRAGMENT_ANCIENT_TABLE1, 1, false, false);
							return "red_foor-15.htm";
						}
						else if(random_tab == 1)
						{
							st.giveItems(FRAGMENT_ANCIENT_TABLE2, 1, false, false);
							return "red_foor-15.htm";
						}
						else if(random_tab == 2)
						{
							st.giveItems(FRAGMENT_ANCIENT_TABLE3, 1, false, false);
							return "red_foor-15.htm";
						}
						else if(random_tab == 3)
						{
							st.giveItems(FRAGMENT_ANCIENT_TABLE4, 1, false, false);
							return "red_foor-15.htm";
						}
					}
				}
		...
		else if(event.equalsIgnoreCase("m_give"))
		{
			if(st.getQuestItemsCount(CARGO_BOX1) > 0)
			{
				...
				if(count > 2)
					count = 2;
				st.giveItems(GUILD_COIN, 1, false, false);
				st.giveItems(ADENA_ID, (1 + count) * 100, true, true);
				st.takeItems(CARGO_BOX1, 1);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(on_npc)
		{
			...
			if(allowDrop == 1 && st.getInt("part") == part)
				...
				{
					st.giveItems(partItem, npcId == 27152 ? 8 : 1, true, true);
					st.playSound(SOUND_ITEMGET);
					if(rand2 < chanceBox)
					{
						st.giveItems(CARGO_BOX1, 1, true, true);
						if(rand > chancePartItem)
							st.playSound(SOUND_ITEMGET);
					}
				}
