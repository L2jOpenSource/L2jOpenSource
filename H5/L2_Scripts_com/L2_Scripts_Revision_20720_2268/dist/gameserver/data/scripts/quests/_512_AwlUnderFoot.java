...
public class _512_AwlUnderFoot extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("exit"))
		{
			...
			if(st.isNotAccepted() || !check(st.getPlayer()))
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{
			st.giveItems(KnightsEpaulette, st.getQuestItemsCount(FragmentOfTheDungeonLeaderMark), false, false);
					...
					case JaxTheDestroyer:
						...
						if(party != null)
							for(Player member : party.getPartyMembers())
							{
								...
								{
									qs.giveItems(FragmentOfTheDungeonLeaderMark, RewardMarksCount / party.getMemberCount(), false, false);
						...
						{
							st.giveItems(FragmentOfTheDungeonLeaderMark, RewardMarksCount, false, false);
