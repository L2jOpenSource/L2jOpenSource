...
public class _223_TestOfChampion extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equals("1"))
		{
			...
			{
				st.giveItems(7562, 64, false, false);
				st.getPlayer().setVar("dd3", "1", -1);
			}
			st.giveItems(ASCALONS_LETTER1, 1, false, false);
		}
		...
		else if(event.equals("30624_2"))
		{
			...
			st.giveItems(ASCALONS_LETTER2, 1, false, false);
		}
		else if(event.equals("30624_3"))
		{
			...
			st.giveItems(ASCALONS_LETTER3, 1, false, false);
		}
		...
		else if(event.equals("30625_2"))
		{
			...
			st.giveItems(IRON_ROSE_RING, 1, false, false);
		}
		else if(event.equals("30093_1"))
		{
			...
			st.giveItems(WHITE_ROSE_INSIGNIA, 1, false, false);
		}
		...
		else if(event.equals("30196_2"))
		{
			...
			st.giveItems(MOUENS_ORDER1, 1, false, false);
		}
		else if(event.equals("30196_3"))
		{
			...
			st.giveItems(MOUENS_ORDER2, 1, false, false);
		}
		return htmltext;
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Ascalon)
		{
			if(cond == 0)
			{
				...
				if(class_id != ClassId.WARRIOR && class_id != ClassId.ORC_RAIDER)
					return "30624-01.htm";
			...
			else if(cond == COND14)
			{
				...
				st.giveItems(MARK_OF_CHAMPION, 1, false, false);
		...
		else if(npcId == Mason)
		{
			...
			else if(cond == COND3)
			{
				...
				st.giveItems(MASONS_LETTER, 1, false, false);
				st.setCond(COND4);
			}
			else if(cond == COND4)
		...
		else if(npcId == Groot)
		{
			...
			else if(cond == COND7)
			{
				...
				st.giveItems(GROOTS_LETTER, 1, false, false);
				st.setCond(COND8);
			}
			else if(cond == COND8)
		...
		else if(npcId == Mouen)
		{
			...
			else if(cond == COND13)
			{
				...
				st.giveItems(MOUENS_LETTER, 1, false, false);
				st.setCond(COND14);
			}
			else if(cond == COND13)
