...
public class _142_FallenAngelRequestOfDawn extends QuestScript
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == RAYMOND)
		{
			...
			else if(cond == 6)
			{
				...
				st.giveItems(ADENA_ID, 92676, true, true);
				st.addExpAndSp(223056, 13901);
				st.finishQuest();
			}
		}
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(npc.getNpcId() == FallenAngel)
		{
			...
			{
				st.setCond(6);
				st.giveItems(BLOOD, 1, false, false);
			}
		}
