 ...
 */
public class _331_ArrowForVengeance extends QuestScript
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(cond == 0)
		{
			...
			{
				st.giveItems(ADENA_ID, (80 * st.getQuestItemsCount(HARPY_FEATHER)) + (90 * st.getQuestItemsCount(MEDUSA_VENOM)) + (100 * st.getQuestItemsCount(WYRMS_TOOTH)), true, true);
