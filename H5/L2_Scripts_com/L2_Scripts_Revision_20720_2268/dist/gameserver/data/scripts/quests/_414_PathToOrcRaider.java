...
public class _414_PathToOrcRaider extends QuestScript
{
	//npc
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(1);
			st.giveItems(GOBLIN_DWELLING_MAP, 1, false, false);
		}
		else if(event.equalsIgnoreCase("to_Gludin"))
		{
			...
			st.giveItems(BETRAYER_UMBAR_REPORT, 1, false, false);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == KASMAN)
		{
			...
			else if(cond == 4 && st.getQuestItemsCount(HEAD_OF_BETRAYER) > 1)
			{
				...
				{
					st.giveItems(MARK_OF_RAIDER, 1, false, false);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == GOBLIN_TOMB_RAIDER_LEADER && cond == 1)
		{
			if(st.getQuestItemsCount(GOBLIN_DWELLING_MAP) == 1 && st.getQuestItemsCount(KURUKA_RATMAN_TOOTH) < 10 && st.getQuestItemsCount(GREEN_BLOOD) < 40)
				...
				{
					st.giveItems(GREEN_BLOOD, 1, true, true);
		...
		else if(npcId == KURUKA_RATMAN_LEADER && cond == 1)
		{
			...
			{
				st.giveItems(KURUKA_RATMAN_TOOTH, 1, true, true);
		...
		else if(npcId == UMBAR_ORC && cond == 3)
		{
			...
			{
				st.giveItems(HEAD_OF_BETRAYER, 1, false, false);
			...
			{
				st.giveItems(TIMORA_ORCS_HEAD, 1, false, false);
				st.addRadar(90000, -143286, -1520);
				st.setCond(7);
			}
		return null;
