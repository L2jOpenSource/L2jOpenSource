 ...
 * @author pchayka
 */
public class _10293_SevenSignsForbiddenBook extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.giveItems(SolinasBiography, 1, false, false);
			st.setCond(7);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch(npcId)
		{
			case Elcardia:
				if(cond == 0)
				{
					if(player.getLevel() >= 81 && st.getPlayer().isQuestCompleted(10292))
