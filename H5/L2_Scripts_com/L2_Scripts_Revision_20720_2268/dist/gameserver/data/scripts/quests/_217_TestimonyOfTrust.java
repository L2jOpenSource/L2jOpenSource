...
public class _217_TestimonyOfTrust extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("1"))
		{
			...
			{
				st.giveItems(7562, 96, false, false);
				st.getPlayer().setVar("dd2", "1", -1);
			}
			htmltext = "hollin_q0217_04.htm";
			st.setCond(1);
			st.set("id", "0");
			st.giveItems(LETTER_TO_ELF_ID, 1, false, false);
			st.giveItems(LETTER_TO_DARKELF_ID, 1, false, false);
		}
		...
		else if(event.equalsIgnoreCase("30154_2"))
		{
			...
			st.giveItems(ORDER_OF_OZZY_ID, 1, false, false);
			st.setCond(2);
		}
		else if(event.equalsIgnoreCase("30358_1"))
		{
			...
			st.giveItems(LETTER_OF_THIFIELL_ID, 1, false, false);
			st.setCond(5);
		}
			...
			if(st.getPlayer().getLevel() >= 38)
			{
				...
				st.giveItems(LETTER_TO_ORC_ID, 1, false, false);
				st.giveItems(LETTER_TO_DWARF_ID, 1, false, false);
				st.setCond(12);
			}
			else
		...
		else if(event.equalsIgnoreCase("30565_1"))
		{
			...
			st.giveItems(LETTER_TO_MANAKIA_ID, 1, false, false);
			st.setCond(13);
		}
		...
		else if(event.equalsIgnoreCase("30531_1"))
		{
			...
			st.giveItems(LETTER_TO_NICHOLA_ID, 1, false, false);
			st.setCond(18);
		}
		else if(event.equalsIgnoreCase("30621_1"))
		{
			...
			st.giveItems(ORDER_OF_NICHOLA_ID, 1, false, false);
			st.setCond(19);
		}
		return htmltext;
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == 30191)
		{
			...
			else if(cond == 9 && st.getQuestItemsCount(SCROLL_OF_ELF_TRUST_ID) > 0 && st.getQuestItemsCount(SCROLL_OF_DARKELF_TRUST_ID) > 0)
			{
				...
				st.giveItems(LETTER_TO_SERESIN_ID, 1, false, false);
				st.setCond(10);
			}
			else if(cond == 22 && st.getQuestItemsCount(SCROLL_OF_DWARF_TRUST_ID) > 0 && st.getQuestItemsCount(SCROLL_OF_ORC_TRUST_ID) > 0)
			{
				...
				st.giveItems(RECOMMENDATION_OF_HOLLIN_ID, 1, false, false);
				st.setCond(23);
			}
			else if(cond == 19)
		...
		else if(npcId == 30154)
		{
			...
			else if(cond == 3 && st.getQuestItemsCount(BREATH_OF_WINDS_ID) > 0 && st.getQuestItemsCount(SEED_OF_VERDURE_ID) > 0)
			{
				...
				st.giveItems(SCROLL_OF_ELF_TRUST_ID, 1, false, false);
				st.setCond(4);
			}
			else if(cond == 4)
		...
		else if(npcId == 30358)
		{
			...
			else if(cond == 8 && st.getQuestItemsCount(STAKATO_ICHOR_ID) + st.getQuestItemsCount(HONEY_DEW_ID) + st.getQuestItemsCount(BASILISK_PLASMA_ID) >= 3)
			{
				...
				st.giveItems(SCROLL_OF_DARKELF_TRUST_ID, 1, false, false);
				st.setCond(9);
		...
		else if(npcId == 30464)
		{
			if(cond == 5 && st.getQuestItemsCount(LETTER_OF_THIFIELL_ID) > 0)
			{
				...
				st.giveItems(ORDER_OF_CLAYTON_ID, 1, false, false);
				st.setCond(6);
			}
		...
		else if(npcId == 30565)
		{
			...
			else if(cond == 16)
			{
				...
				st.giveItems(SCROLL_OF_ORC_TRUST_ID, 1, false, false);
				st.setCond(17);
			}
			else if(cond >= 17)
		...
		else if(npcId == 30515)
		{
			...
			else if(cond == 15 && st.getQuestItemsCount(PARASITE_OF_LOTA_ID) >= 10)
			{
				...
				st.giveItems(LETTER_OF_MANAKIA_ID, 1, false, false);
				st.setCond(16);
			}
			else if(cond == 16)
		...
		else if(npcId == 30531)
		{
			...
			else if(cond == 21)
			{
				...
				st.giveItems(SCROLL_OF_DWARF_TRUST_ID, 1, false, false);
				st.setCond(22);
			}
			else if(cond == 22)
		...
		else if(npcId == 30031 && cond == 23 && st.getQuestItemsCount(RECOMMENDATION_OF_HOLLIN_ID) > 0)
		{
			...
			st.giveItems(MARK_OF_TRUST_ID, 1, false, false);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == 27120)
		{
			if(cond == 2 && st.getQuestItemsCount(BREATH_OF_WINDS_ID) == 0)
				...
				{
					st.giveItems(BREATH_OF_WINDS_ID, 1, false, false);
					st.setCond(3);
				}
				else
				{
		...
		else if(npcId == 27121)
		{
			if(cond == 2 && st.getQuestItemsCount(SEED_OF_VERDURE_ID) == 0)
				...
				{
					st.giveItems(SEED_OF_VERDURE_ID, 1, false, false);
					st.setCond(3);
				}
				else
				{
		...
		else if(npcId == 20550)
		{
			...
			{
				st.giveItems(BLOOD_OF_GUARDIAN_BASILISK_ID, 1, false, false);
				if(st.getQuestItemsCount(BLOOD_OF_GUARDIAN_BASILISK_ID) > 9)
				{
					st.takeItems(BLOOD_OF_GUARDIAN_BASILISK_ID, -1);
					st.giveItems(BASILISK_PLASMA_ID, 1, false, false);
		...
		else if(npcId == 20157 || npcId == 20230 || npcId == 20232 || npcId == 20234)
		{
			...
			{
				st.giveItems(STAKATOS_FLUIDS_ID, 1, false, false);
				if(st.getQuestItemsCount(STAKATOS_FLUIDS_ID) > 9)
				{
					st.takeItems(STAKATOS_FLUIDS_ID, -1);
					st.giveItems(STAKATO_ICHOR_ID, 1, false, false);
					if(st.getQuestItemsCount(STAKATO_ICHOR_ID) + st.getQuestItemsCount(BASILISK_PLASMA_ID) + st.getQuestItemsCount(HONEY_DEW_ID) >= 3)
						st.setCond(7);
				}
				else
		...
		else if(npcId == 20082 || npcId == 20086 || npcId == 20087 || npcId == 20084 || npcId == 20088)
		{
			...
			{
				st.giveItems(GIANT_APHID_ID, 1, false, false);
				if(st.getQuestItemsCount(GIANT_APHID_ID) > 9)
				{
					st.takeItems(GIANT_APHID_ID, -1);
					st.giveItems(HONEY_DEW_ID, 1, false, false);
					if(st.getQuestItemsCount(STAKATO_ICHOR_ID) + st.getQuestItemsCount(BASILISK_PLASMA_ID) + st.getQuestItemsCount(HONEY_DEW_ID) >= 3)
						st.setCond(7);
				}
				else
		...
		else if(npcId == 20553)
		{
			...
			{
				st.giveItems(PARASITE_OF_LOTA_ID, 1, true, true);
		...
		{
			st.giveItems(HEART_OF_PORTA_ID, 1, false, false);
			st.setCond(20);
		}
		return null;
	}
