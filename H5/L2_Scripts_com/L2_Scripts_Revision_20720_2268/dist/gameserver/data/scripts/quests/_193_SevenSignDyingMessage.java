...
public class _193_SevenSignDyingMessage extends QuestScript
{
	// NPCs
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(1);
			st.giveItems(JacobsNecklace, 1, false, false);
		}
		...
		{
			st.setCond(3);
			st.giveItems(DeadmansHerb, 1, false, false);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Hollint)
		{
			if(cond == 0)
			{
				...
				if(player.isQuestCompleted(192))
					return "30191-01.htm";
			}
			else if(cond == 1)
				return "30191-03.htm";
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == ShilensEvilThoughts && cond == 4)
		{
			...
			if(obj_id != null && obj_id.intValue() == npc.getObjectId())
			{
				...
				st.giveItems(SculptureofDoubt, 1, false, false);
			}
		}
		return null;
	}
