 ...
 */
public class _222_TestOfDuelist extends QuestScript
{
	//NPC
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(2);
			st.giveItems(OrderGludio, 1, false, false);
			st.giveItems(OrderDion, 1, false, false);
			st.giveItems(OrderGiran, 1, false, false);
			st.giveItems(OrderOren, 1, false, false);
			st.giveItems(OrderAden, 1, false, false);
		...
		else if(event.equalsIgnoreCase("30623-16.htm"))
		{
			...
			st.giveItems(FinalOrder, 1, false, false);
			st.setCond(4);
		}
		return htmltext;
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Kaien)
			...
			else if(st.getQuestItemsCount(MarkOfDuelist) != 0)
			{
			...
			{
				st.giveItems(MarkOfDuelist, 1, false, false);
