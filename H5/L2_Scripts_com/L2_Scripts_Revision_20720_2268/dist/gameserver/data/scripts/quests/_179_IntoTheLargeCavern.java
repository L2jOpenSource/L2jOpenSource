...
public class _179_IntoTheLargeCavern extends QuestScript implements OnDeathListener
{
	public class World
	{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(st.getCond() == 0)
		{
			...
			else if(player.getLevel() > 20 || player.getClassLevel() > 0)
				htmltext = "32138-02a.htm";
			else if(!player.isQuestCompleted(178))
