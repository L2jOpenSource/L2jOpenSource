...
public class _259_RanchersPlea extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equals("30405_9"))
		{
			...
			st.giveItems(SPSSNG_ID, 30, false, false);
			st.takeItems(GIANT_SPIDER_SKIN_ID, 10);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == 30497 && st.getCond() == 1 && st.getQuestItemsCount(GIANT_SPIDER_SKIN_ID) >= 1)
		{
			...
			st.giveItems(ADENA_ID, st.getQuestItemsCount(GIANT_SPIDER_SKIN_ID) * 25, true, true);
