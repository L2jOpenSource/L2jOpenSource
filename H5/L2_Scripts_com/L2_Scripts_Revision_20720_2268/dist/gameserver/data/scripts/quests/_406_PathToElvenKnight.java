...
public class _406_PathToElvenKnight extends QuestScript
{
	//NPC
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("blacksmith_kluto_q0406_02.htm"))
		{
			...
			st.giveItems(KlutosMemo, 1, false, false);
			st.setCond(4);
		}
		else
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Sorius)
		{
			...
			else if(cond == 2)
			{
				...
				st.giveItems(SoriussLetter, 1, false, false);
			...
			else if(cond == 6)
			{
				...
				{
					st.giveItems(ElvenKnightBrooch, 1, false, false);
			...
			else if(cond == 5)
			{
				...
				st.giveItems(KlutoBox, 1, false, false);
