...
public class _046_OnceMoreInTheArmsOfTheMotherTree extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equals("3"))
		{
			...
			st.giveItems(GALLADUCCIS_ORDER_DOCUMENT_ID_2, 1, false, false);
		...
		else if(event.equals("4"))
		{
			...
			st.giveItems(GEMSTONE_POWDER_ID, 1, false, false);
		...
		else if(event.equals("5"))
		{
			...
			st.giveItems(GALLADUCCIS_ORDER_DOCUMENT_ID_3, 1, false, false);
		...
		else if(event.equals("6"))
		{
			...
			st.giveItems(PURIFIED_MAGIC_NECKLACE_ID, 1, false, false);
			htmltext = "dustin_q0046_0601.htm";
		}
		else if(event.equals("7"))
		{
			st.giveItems(SCROLL_OF_ESCAPE_ELVEN_VILLAGE, 1, false, false);
