 ...
 * @author VISTALL
 */
public class _504_CompetitionForTheBanditStronghold extends QuestScript
{
	// NPC
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(1);
			st.giveItems(CONTEST_CERTIFICATE, 1, false, false);
		}
		return htmlText;
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else
		{
			...
			else if(st.getQuestItemsCount(CONTEST_CERTIFICATE) == 1 && st.getQuestItemsCount(AMULET) >= 30)
			{
				...
				st.giveItems(ALIANCE_TROPHEY, 1, false, false);
				st.finishQuest();
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			st.giveItems(AMULET, 1, true, true);
