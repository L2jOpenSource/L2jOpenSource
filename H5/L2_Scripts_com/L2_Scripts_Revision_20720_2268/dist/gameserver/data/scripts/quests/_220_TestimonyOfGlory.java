...
public class _220_TestimonyOfGlory extends QuestScript
{
	//NPC
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(1);
			st.giveItems(VokiansOrder, 1, false, false);
			if(!st.getPlayer().getVarBoolean("dd2"))
			{
				st.giveItems(7562, 109, false, false);
		...
		else if(event.equalsIgnoreCase("30642-03.htm"))
		{
			...
			st.giveItems(ChiantaOrder1st, 1, false, false);
			st.setCond(4);
		}
		else if(event.equalsIgnoreCase("30571-03.htm"))
		{
			st.takeItems(ScepterBox, -1);
			st.giveItems(TanapisOrder, 1, false, false);
			st.setCond(9);
		}
		else if(event.equalsIgnoreCase("30642-07.htm"))
		{
			...
			{
				st.giveItems(ChiantasOrder3rd, 1, false, false);
				st.setCond(6);
			}
			else
			{
				htmltext = "30642-06.htm";
				st.giveItems(ChiantasOrder2rd, 1, false, false);
			}
		}
		else if(event.equalsIgnoreCase("BREKA"))
		{
			...
			else
			{
				...
				st.giveItems(ManakiaLetter1st, 1, false, false);
			}
		}
		else if(event.equalsIgnoreCase("ENKU"))
		{
			...
			else
			{
				...
				st.giveItems(ManakiaLetter2st, 1, false, false);
			}
		}
		else if(event.equalsIgnoreCase("VUKU"))
		{
			...
			else
			{
				...
				st.giveItems(KasmansLetter1rd, 1, false, false);
			}
		}
		else if(event.equalsIgnoreCase("TUREK"))
		{
			...
			else
			{
				...
				st.giveItems(KasmansLetter2rd, 1, false, false);
			}
		}
		else if(event.equalsIgnoreCase("TUNATH"))
		{
			...
			else
			{
				...
				st.giveItems(KasmansLetter3rd, 1, false, false);
			}
		}
		else if(event.equalsIgnoreCase("30615-04.htm"))
		{
			...
			else
			{
				...
				st.giveItems(GloveOfVoltar, 1, false, false);
		...
		else if(event.equalsIgnoreCase("30616-04.htm"))
		{
			...
			else
			{
				...
				st.giveItems(GloveOfKepra, 1, false, false);
		...
		else if(event.equalsIgnoreCase("30617-04.htm"))
		{
			...
			else
			{
				...
				st.giveItems(GloveOfBurai, 1, false, false);
		...
		else if(event.equalsIgnoreCase("30618-03.htm"))
		{
			...
			st.giveItems(ScepterOfTunath, 1, false, false);
		...
		else if(event.equalsIgnoreCase("30619-03.htm"))
		{
			...
			st.giveItems(DrikosContract, 1, false, false);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Vokian)
		{
			...
			else if(st.getQuestItemsCount(MarkOfGlory) != 0)
			{
			...
			else if(cond == 2)
			{
				...
				st.giveItems(VokiansOrder2, 1, false, false);
				st.giveItems(NecklaceOfAuthority, 1, false, false);
		...
		else if(npcId == Chianta)
		{
			...
			else if(cond == 7)
			{
				...
				st.giveItems(ScepterBox, 1, false, false);
		...
		else if(npcId == Voltar)
		{
			if(cond == 4)
				...
				else if(st.getQuestItemsCount(PashikasHead) > 0 && st.getQuestItemsCount(VultusHead) > 0)
				{
					...
					st.giveItems(ScepterOfBreka, 1, false, false);
		...
		else if(npcId == Kepra)
		{
			if(cond == 4)
				...
				else if(st.getQuestItemsCount(EnkuOverlordHead) >= 4)
				{
					...
					st.giveItems(ScepterOfEnku, 1, false, false);
					if(st.getQuestItemsCount(ScepterOfBreka) > 0 && st.getQuestItemsCount(ScepterOfEnku) > 0 && st.getQuestItemsCount(ScepterOfVuku) > 0 && st.getQuestItemsCount(ScepterOfTurek) > 0 && st.getQuestItemsCount(ScepterOfTunath) > 0)
					{
						st.setCond(5);
					}
		...
		else if(npcId == Burai)
		{
			if(cond == 4)
				...
				else if(st.getQuestItemsCount(MakumBugbearHead) >= 2)
				{
					...
					st.giveItems(ScepterOfTurek, 1, false, false);
					if(st.getQuestItemsCount(ScepterOfBreka) > 0 && st.getQuestItemsCount(ScepterOfEnku) > 0 && st.getQuestItemsCount(ScepterOfVuku) > 0 && st.getQuestItemsCount(ScepterOfTurek) > 0 && st.getQuestItemsCount(ScepterOfTunath) > 0)
					{
						st.setCond(5);
					}
		...
		else if(npcId == Driko)
		{
			if(cond == 4)
				...
				else if(st.getQuestItemsCount(DrikosContract) > 0)
				{
					if(st.getQuestItemsCount(StakatoDroneHusk) >= 30)
					{
						...
						st.giveItems(ScepterOfVuku, 1, false, false);
						if(st.getQuestItemsCount(ScepterOfBreka) > 0 && st.getQuestItemsCount(ScepterOfEnku) > 0 && st.getQuestItemsCount(ScepterOfVuku) > 0 && st.getQuestItemsCount(ScepterOfTurek) > 0 && st.getQuestItemsCount(ScepterOfTunath) > 0)
						{
							st.setCond(5);
						}
			...
			else if(cond == 10)
			{
				...
				st.giveItems(RitualBox, 1, false, false);
		...
		if(npcId == Kakai && cond == 11)
		{
			...
			st.giveItems(MarkOfGlory, 1, false, false);
			if(!st.getPlayer().getVarBoolean("prof2.2"))
			{
				st.addExpAndSp(1448226, 96648);
				st.giveItems(ADENA_ID, 262720, true, true);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(cond == 4)
		{
			if(npcId == PashikasSonOfVoltarQuestMonster)
			{
				...
				if(st.getQuestItemsCount(GloveOfVoltar) > 0 && st.getQuestItemsCount(PashikasHead) == 0)
					st.giveItems(PashikasHead, 1, false, false);
			}
			else if(npcId == VultusSonOfVoltarQuestMonster)
			{
				...
				if(st.getQuestItemsCount(GloveOfVoltar) > 0 && st.getQuestItemsCount(VultusHead) == 0)
					st.giveItems(VultusHead, 1, false, false);
			}
		}
		else if(cond == 6 && st.getQuestItemsCount(TimakOrcHead) >= 20 && st.getQuestItemsCount(TamlinOrcSkull) >= 20)
		{
			...
			else if(npcId == RevenantOfTantosChief)
			{
				...
				if(isQuest != null)
					isQuest.deleteMe();
				st.giveItems(ScepterOfTantos, 1, false, false);
				st.setCond(10);
			}
		return null;
	}
