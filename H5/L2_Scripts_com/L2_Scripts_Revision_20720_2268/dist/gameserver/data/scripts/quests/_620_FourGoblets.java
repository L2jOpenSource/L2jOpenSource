...
public class _620_FourGoblets extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("12"))
		{
			...
			st.giveItems(ANTIQUE_BROOCH, 1, false, false);
			st.setCond(2);
			return "31453-16.htm";
		}
		...
		else if(event.equalsIgnoreCase("18"))
		{
			...
			return "<html><body><a action=\"bypass -h npc_%objectId%_QuestEvent 620 19\">\"Please open a box.\"</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent 620 19 5\">\"Please open 5 boxes.\"</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent 620 19 10\">\"Please open 10 boxes.\"</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent 620 19 50\">\"Please open 50 boxes.\"</a><br></body></html>";
		else
		{
			int id = 0;
			try
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			st.giveItems(Sealed_Box, 1, false, false);
