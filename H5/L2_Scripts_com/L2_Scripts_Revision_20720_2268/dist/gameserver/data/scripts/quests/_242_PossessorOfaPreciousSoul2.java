...
public class _242_PossessorOfaPreciousSoul2 extends QuestScript
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(8);
			st.giveItems(SORCERY_INGREDIENT, 1, false, false);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == 31743)
		{
			...
			else if(cond == 11)
			{
				...
				st.giveItems(CARADINE_LETTER, 1, false, false);
		...
		else if(npcId == 31752)
		{
			if(cond == 4)
			{
				st.giveItems(BLONDE_STRAND, 1, false, false);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(st.getCond() == 9 && st.getQuestItemsCount(ORB_OF_BINDING) < 4)
			st.giveItems(ORB_OF_BINDING, 1, true, true);
