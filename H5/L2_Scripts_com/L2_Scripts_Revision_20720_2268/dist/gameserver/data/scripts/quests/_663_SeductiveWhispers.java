...
public class _663_SeductiveWhispers extends QuestScript
{
	// NPCs
	...
	static
	{
		...
		Dialog_WinLevel += "<a action=\"bypass -h npc_%objectId%_QuestEvent 663 30846_12.htm\">Pull next card!</a><br>";
		Dialog_WinLevel += "<a action=\"bypass -h npc_%objectId%_QuestEvent 663 30846_13.htm\">\"No, enough for me, end game and take my prize.\"</a>";
		...
		Dialog_WinGame += "<a action=\"bypass -h npc_%objectId%_QuestEvent 663 30846_03.htm\">Return</a>";
		...
		Dialog_Rewards += "<a action=\"bypass -h npc_%objectId%_QuestEvent 663 30846_03.htm\">Return</a>";
	}
	...
	private static class LevelRewards
	{
		...
		public void giveRewards(QuestState qs)
		{
			for(int[] item_ids : rewards.keySet())
				qs.giveItems(item_ids[Rnd.get(item_ids.length)], rewards.get(item_ids), false, false);
		}
