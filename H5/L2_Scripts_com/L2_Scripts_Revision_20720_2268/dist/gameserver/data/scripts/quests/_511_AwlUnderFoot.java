...
public class _511_AwlUnderFoot extends QuestScript
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{
			st.giveItems(KnightsEpaulette, st.getQuestItemsCount(DungeonLeaderMark), false, false);
					...
					case GergTheHunter:
						...
						if(party != null)
							for(Player member : party.getPartyMembers())
							{
								...
								{
									qs.giveItems(DungeonLeaderMark, RewardMarksCount / party.getMemberCount(), false, false);
						...
						{
							st.giveItems(DungeonLeaderMark, RewardMarksCount, false, false);
