...
public class ItemBroker extends Functions
{
	...
	public String getHtmlAppends(Integer val)
	{
		...
		switch(val)
		{
			case 0:
				if(getSelf().isLangRus())
				{
					...
					append.append("<a action=\"bypass -h npc_%objectId%_Chat 11\"><font color=\"FF9900\">Список продаваемых товаров</font></a><br1>");
					append.append("<a action=\"bypass -h npc_%objectId%_Chat 13\"><font color=\"FF9900\">Список покупаемых товаров</font></a><br1>");
					append.append("<a action=\"bypass -h npc_%objectId%_Chat 15\"><font color=\"FF9900\">Список создаваемых товаров</font></a><br1>");
				}
				else
				{
					append.append("<br><font color=\"LEVEL\">Search for dealers:</font><br1>");
					append.append("<a action=\"bypass -h npc_%objectId%_Chat 11\"><font color=\"FF9900\">The list of goods for sale</font></a><br1>");
					append.append("<a action=\"bypass -h npc_%objectId%_Chat 13\"><font color=\"FF9900\">The list of goods to buy</font></a><br1>");
					append.append("<a action=\"bypass -h npc_%objectId%_Chat 15\"><font color=\"FF9900\">The list of goods to craft</font></a><br1>");
				}
				break;
			...
			case 20 + Player.STORE_PRIVATE_MANUFACTURE:
				...
				if(getSelf().isLangRus())
				{
					...
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 1 1 0 0\"><font color=\"FF9900\">Оружие</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 2 1 0 0\"><font color=\"FF9900\">Броня</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 3 1 0 0\"><font color=\"FF9900\">Бижутерия</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 4 1 0 0\"><font color=\"FF9900\">Украшения</font></a><br1>");

					append.append("<br><a action=\"bypass -h npc_%objectId%_Chat ").append(10+type).append("\"><font color=\"FF9900\">Назад</font></a>");
				}
				else
				{
					append.append("The list of equipment:<br>");

					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 1 1 0 0\"><font color=\"FF9900\">Weapons</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 2 1 0 0\"><font color=\"FF9900\">Armors</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 3 1 0 0\"><font color=\"FF9900\">Jewels</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 4 1 0 0\"><font color=\"FF9900\">Accessories</font></a><br1>");

					append.append("<br><a action=\"bypass -h npc_%objectId%_Chat ").append(10+type).append("\"><font color=\"FF9900\">Back</font></a>");
				}
			...
			case 30 + Player.STORE_PRIVATE_MANUFACTURE:
				...
				if(getSelf().isLangRus())
				{
					...
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 1 1 4 0\"><font color=\"FF9900\">Оружие</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 2 1 4 0\"><font color=\"FF9900\">Броня</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 3 1 4 0\"><font color=\"FF9900\">Бижутерия</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 4 1 4 0\"><font color=\"FF9900\">Украшения</font></a><br1>");
				...
				else
				{
					...
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 1 1 4 0\"><font color=\"FF9900\">Weapons+</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 2 1 4 0\"><font color=\"FF9900\">Armors+</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 3 1 4 0\"><font color=\"FF9900\">Jewels+</font></a><br1>");
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 4 1 4 0\"><font color=\"FF9900\">Accessories+</font></a><br1>");					
		...
		if(type > 0)
			if(getSelf().isLangRus())
			{
				...
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 0 1 0 0\"><font color=\"FF9900\">Весь список</font></a><br1>");
				append.append("<a action=\"bypass -h npc_%objectId%_Chat ").append(type+20).append("\"><font color=\"FF9900\">Снаряжение</font></a><br1>");
				if (type == Player.STORE_PRIVATE_SELL)
					append.append("<a action=\"bypass -h npc_%objectId%_Chat ").append(type+30).append("\"><font color=\"FF9900\">Снаряжение +4 и выше</font></a><br1>");
				if (type != Player.STORE_PRIVATE_MANUFACTURE)
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 0 1 0 1\"><font color=\"FF9900\">Редкое снаряжение</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 5 1 0 0\"><font color=\"FF9900\">Расходные материалы</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 6 1 0 0\"><font color=\"FF9900\">Ингредиенты</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 7 1 0 0\"><font color=\"FF9900\">Ключевые ингредиенты</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 8 1 0 0\"><font color=\"FF9900\">Рецепты</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 9 1 0 0\"><font color=\"FF9900\">Книги и амулеты</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 10 1 0 0\"><font color=\"FF9900\">Предметы для улучшения</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 11 1 0 0\"><font color=\"FF9900\">Разное</font></a><br1>");
				if (type != Player.STORE_PRIVATE_MANUFACTURE)
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 90 1 0 0\"><font color=\"FF9900\">Стандартные предметы</font></a><br1>"); // отсутствующий элемент

				append.append("<edit var=\"tofind\" width=100><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:find ").append(type).append(" 1 $tofind\"><font color=\"FF9900\">Найти</font></a><br1>"); // DS: разобраться как и почему вместо \\$var стало нужно использовать $var

				append.append("<br><a action=\"bypass -h npc_%objectId%_Chat 0\"><font color=\"FF9900\">Назад</font></a>");
			}
			else
			{
				append.append("The list of goods to ").append(typeNameEn).append(":<br>");

				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 0 1 0 0\"><font color=\"FF9900\">List all</font></a><br1>");
				append.append("<a action=\"bypass -h npc_%objectId%_Chat ").append(type+20).append("\"><font color=\"FF9900\">Equipment</font></a><br1>");
				if(type == Player.STORE_PRIVATE_SELL)
					append.append("<a action=\"bypass -h npc_%objectId%_Chat ").append(type+30).append("\"><font color=\"FF9900\">Equipment +4 and more</font></a><br1>");
				if (type != Player.STORE_PRIVATE_MANUFACTURE)
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 0 1 0 1\"><font color=\"FF9900\">Rare equipment</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 5 1 0 0\"><font color=\"FF9900\">Consumable</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 6 1 0 0\"><font color=\"FF9900\">Matherials</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 7 1 0 0\"><font color=\"FF9900\">Key matherials</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 8 1 0 0\"><font color=\"FF9900\">Recipies</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 9 1 0 0\"><font color=\"FF9900\">Books and amulets</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 10 1 0 0\"><font color=\"FF9900\">Enchant items</font></a><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 11 1 0 0\"><font color=\"FF9900\">Other</font></a><br1>");
				if (type != Player.STORE_PRIVATE_MANUFACTURE)
					append.append("<a action=\"bypass -h scripts_services.ItemBroker:list ").append(type).append(" 90 1 0 0\"><font color=\"FF9900\">Commons</font></a><br1>");

				append.append("<edit var=\"tofind\" width=100><br1>");
				append.append("<a action=\"bypass -h scripts_services.ItemBroker:find ").append(type).append(" 1 $tofind\"><font color=\"FF9900\">Find</font></a><br1>"); // DS: разобраться как и почему вместо \\$var стало нужно использовать $var

				append.append("<br><a action=\"bypass -h npc_%objectId%_Chat 0\"><font color=\"FF9900\">Back</font></a>");
			}
	...
	public void list(String[] var)
	{
		...
		out.append("<a action=\"bypass -h npc_%objectId%_Chat 1");
		out.append(type);
		out.append("\">««</a>&nbsp;&nbsp;");
		...
		if(items.size() > 0)
		{
			...
			while (iter.hasNext() && count < MAX_ITEMS_PER_PAGE)
			{
				...
				out.append("</td><td><table width=100%><tr><td><a action=\"bypass -h scripts_services.ItemBroker:listForItem ");
				out.append(type);
				out.append(" ");
	...
	public void listForItem(String[] var)
	{
		...
		if (items.size() > 0)
		{
			...
			while (iter.hasNext() && count < MAX_ITEMS_PER_PAGE)
			{
				...
				out.append("<tr><td>");
				out.append(temp.getIcon32());
				out.append("</td><td><table width=100%><tr><td><a action=\"bypass -h scripts_services.ItemBroker:path ");
				out.append(type);
				out.append(" ");
				out.append(item.itemId);
				out.append(" ");
	...
	{
		out.append("<a action=\"bypass -h scripts_services.ItemBroker:listForItem ");
		out.append(type);
		out.append(" ");
		out.append(itemId);
		out.append(" ");
				...
				switch(type)
				{
					...
					case Player.STORE_PRIVATE_MANUFACTURE:
						...
						for(ManufactureItem mitem : createList)
						{
							...
							Item newItem = new Item(product.getItemId(), type, mitem.getCost(), product.getCount(), 0, temp.getName(), pl.getObjectId(), pl.getName(), pl.getLoc(), itemObjId++, null, false);
							long key = newItem.price * 100;
							while(key < newItem.price * 100 + 100 && oldItems.containsKey(key))
								// До 100 предметов с одинаковыми ценами
								key++;
	...
	public void find(String[] var)
	{
		...
		{
			if (player.isLangRus())
				show("Пожалуйста введите от 1 до 16 символов.<br><a action=\"bypass -h npc_%objectId%_Chat 0\"><font color=\"FF9900\">Назад</font></a>", player, npc);
			else
				show("Please enter from 1 up to 16 symbols.<br><a action=\"bypass -h npc_%objectId%_Chat 0\"><font color=\"FF9900\">Back</font></a>", player, npc);
			return;
		}
	...
	{
		out.append("<a action=\"bypass -h scripts_services.ItemBroker:find ");
		out.append(type);
		out.append(" ");
		out.append(page);
		if (search != null)
