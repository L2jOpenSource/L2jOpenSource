...
public class TeleToParnassus extends Functions implements ScriptFile
{
	...
	private static final String en = "<br>[scripts_services.TeleToParnassus:toParnassus @811;Parnassus|\"Parnassus (offshore zone) - " + Config.SERVICES_PARNASSUS_PRICE + " Adena\"]";
	private static final String ru = "<br>[scripts_services.TeleToParnassus:toParnassus @811;Парнас|\"Парнас (оффшорная зона) - " + Config.SERVICES_PARNASSUS_PRICE + " Аден\"]";
	private static final String enFree = "<br>[scripts_services.TeleToParnassus:toParnassus @811;Parnassus|\"Parnassus (offshore zone) - Free\"]";
	private static final String ruFree = "<br>[scripts_services.TeleToParnassus:toParnassus @811;Парнас|\"Парнас (оффшорная зона) - Бесплатно\"]";
	...
	public String getHtmlAppends(Integer val)
	{
		...
		if(player == null)
			return "";
		if(Config.SERVICES_PARNASSUS_PRICE > 0)
