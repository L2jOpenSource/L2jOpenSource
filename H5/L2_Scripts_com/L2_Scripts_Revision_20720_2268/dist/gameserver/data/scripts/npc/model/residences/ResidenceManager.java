...
public abstract class ResidenceManager extends MerchantInstance
{
	...
	private void sendHtmlMessage(Player player, NpcHtmlMessagePacket html)
	{
		html.replace("%npcname%", HtmlUtils.htmlNpcName(getNpcId())) ;
		player.sendPacket(html);
	}

	private void replace(NpcHtmlMessagePacket html, int type, String replace1, String replace2)
	{
