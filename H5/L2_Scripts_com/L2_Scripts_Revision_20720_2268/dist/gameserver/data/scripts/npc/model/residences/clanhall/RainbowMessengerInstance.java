	...
	public void onBypassFeedback(final Player player, final String command)
	{
		...
		else if(command.equalsIgnoreCase("cancel"))
		{
			...
			else
			{
				...
				ItemFunctions.addItem(player, ITEM_ID, siegeClanObject.getParam() / 2L, true, "Cancel siege registration by RainbowMessengerInstance");
		...
		else if(command.equalsIgnoreCase("refund"))
		{
			...
			else
			{
				...
				ItemFunctions.addItem(player, ITEM_ID, siegeClanObject.getParam(), true, "Refund siege registration by RainbowMessengerInstance");
