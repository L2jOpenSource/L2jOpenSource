...
public class heart extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	private void reward(Player player, int guesses)
	{
		switch(guesses)
		{
			case -1:
			case 0:
				ItemFunctions.addItem(player, scrolls[Rnd.get(scrolls.length)], 1, "Heart event reward");
				break;
			case 1:
				ItemFunctions.addItem(player, potions[Rnd.get(potions.length)], 10, "Heart event reward");
				break;
			case 2:
				ItemFunctions.addItem(player, 1538, 1, "Heart event reward"); // 1  Blessed Scroll of Escape
				break;
			case 3:
				ItemFunctions.addItem(player, 3936, 1, "Heart event reward"); // 1  Blessed Scroll of Resurrection
				break;
			case 4:
				ItemFunctions.addItem(player, 951, 2, "Heart event reward"); // 2  Scroll: Enchant Weapon (C)
				break;
			case 5:
				ItemFunctions.addItem(player, 948, 4, "Heart event reward"); // 4  Scroll: Enchant Armor (B)
				break;
			case 6:
				ItemFunctions.addItem(player, 947, 1, "Heart event reward"); // 1  Scroll: Enchant Weapon (B)
				break;
			case 7:
				ItemFunctions.addItem(player, 730, 3, "Heart event reward"); // 3  Scroll: Enchant Armor (A)
				break;
			case 8:
				ItemFunctions.addItem(player, 729, 1, "Heart event reward"); // 1  Scroll: Enchant Weapon (A)
				break;
			case 9:
				ItemFunctions.addItem(player, 960, 2, "Heart event reward"); // 2  Scroll: Enchant Armor (S)
				break;
			case 10:
				ItemFunctions.addItem(player, 959, 1, "Heart event reward"); // 1  Scroll: Enchant Weapon (S)
				break;
		}
	}
