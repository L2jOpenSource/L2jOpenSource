...
public class RimPailaka extends Reflection
{
	...
	private static final int KanadisHerald1 = 25653;
	private static final int KanadisHerald2 = 25654;
	private static final int KanadisHerald3 = 25655;
	...
	private static final int KanadisFanatic1 = 25656;
	private static final int KanadisFanatic2 = 25657;
	private static final int KanadisFanatic3 = 25658;
	...
	public class FirstWave extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			addSpawnWithoutRespawn(type == 1 ? KanadisGuide1 : KanadisHerald1, bossnminions, 0);
			for(int i = 0; i < 10; i++)
				addSpawnWithoutRespawn(type == 1 ? KanadisFollower1 : KanadisFanatic1, bossnminions, 400);
	...
	public class SecondWave extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			Location bossnminions = new Location(50536, -12232, -9384, 32768);
			addSpawnWithoutRespawn(type == 1 ? KanadisGuide2 : KanadisHerald2, bossnminions, 0);
			for(int i = 0; i < 10; i++)
				addSpawnWithoutRespawn(type == 1 ? KanadisFollower2 : KanadisFanatic2, bossnminions, 400);
	...
	public class ThirdWave extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			Location bossnminions = new Location(50536, -12232, -9384, 32768);
			addSpawnWithoutRespawn(type == 1 ? KanadisGuide3 : KanadisHerald3, bossnminions, 100);
			addSpawnWithoutRespawn(type == 1 ? KanadisGuide3 : KanadisHerald3, bossnminions, 100);
			for(int i = 0; i < 10; i++)
				addSpawnWithoutRespawn(type == 1 ? KanadisFollower3 : KanadisFanatic3, bossnminions, 400);
		}
	}
